...
class SCElement(SCObject, NodePath):
    ...
    def finalize(self, dbArgs={}):
        ...
        btn.bind(DGG.B1PRESS, self.onMouseClick, extraArgs=[0])
        btn.bind(DGG.B2PRESS, self.onMouseClick, extraArgs=[1])
        btn.bind(DGG.B3PRESS, self.onMouseClick, extraArgs=[2])
        self.button = btn
