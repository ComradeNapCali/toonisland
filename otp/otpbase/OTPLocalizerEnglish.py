...
SecretFriendsInfoPanelText = [
    '\nThe Open Chat with True Friends Feature\n\nThe Open Chat with True Friends feature enables a member to chat directly with another member within Toon Island: Aftermath (the "Service") once the members establish a True Friends connection. Here is a detailed description of the process of creating an Open Chat with True Friends connection between members whom we will call "John" and "Little Cat."\n1. First, John requests a True Friend Code (described below) from within the Service.\n',
...
CreateAccountScreenAccountNameTooShort = (
    "Your account name must be at least %s characters long. Please try again."
)
CreateAccountScreenPasswordTooShort = (
    "Your password must be at least %s characters long. Please try again."
)
...
CreateAccountScreenUserNameNotFound = (
...
FriendSecretIntro = "If you are playing Toon Island: Aftermath with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on their screen, you'll be True Friends in Toontown!"
...
FriendSecretEnteredSecretFullNoName = (
...
# across the DigiPulse network? :thinking:
...
GuildInviterFriendDemotedGM = (
    "%s has been named by %s as the new GuildMaster who became the rank of %s"
)
GuildInviterFriendDemotedGMP = (
    "%s have been named by %s as the new GuildMaster who beaome the rank of %s"
)
...
SpeedChatStaticTextToontown = {
    ...
    550: "What are your pronouns?",
    551: "I use he/him pronouns.",
    552: "I use he/they pronouns.",
    553: "I use she/her pronouns.",
    554: "I use she/they pronouns.",
    555: "I use they/them pronouns",
    556: "I use they/he pronouns",
    557: "I use they/she pronouns",
    558: "I use any pronouns.",
    559: "I use all pronouns",
    559: "My pronouns vary",
    560: "I don't use pronouns",
    600: "You look nice.",
    601: "You are awesome!",
    602: "You rock!",
    ...
    30110: "Mickey is in Withering Woods.",
    30111: "Daisy is in Toon Island Central.",
    30112: "Minnie is in Cirrus Circus.",
    ...
    30452: "It's on Raven Road in Withering Woods.",
}
...
KartRacingMenuSections = [-1, "PLACES", "RACES", "TRACKS", "COMPLIMENTS", "TAUNTS"]
AprilToonsMenuSections = [-1, "GREETINGS", "PLAYGROUNDS", "CHARACTERS", "ESTATES"]
