...
__mickeyWaypoints = (
    ("a", "e", 1, []),
    ("b", "e", 1, []),
    ("e", "f", 1, [Point3(-76.87, -7.85, -1.85), Point3(-80.57, -4.0, -1.85)]),
...
__minniePaths = {
    ...
    "h": (Point3(128.983, -49.656, -0.231), ("e", "g", "i", "j")),
...
__goofyPaths = {
    "a": (Point3(64.995, 169.665, 10.027), ("b", "q")),
...
__donaldPaths = {
    "a": (Point3(-94.883, -94.024, 0.025), "b"),
...
__plutoWaypoints = (
    ...
    ("d", "e", 0, [Point3(-25.8, 60.0, 6.2), Point3(-61.9, 64.5, 6.2)]),
    (
        "e",
        "a",
        1,
...
__chipPaths = {
    "a": (Point3(50.004, 102.725, 0.6), ("b", "k")),
    ...
    "j": (Point3(-40.092, 2.784, 1.268), ("k", "b", "f", "g")),
