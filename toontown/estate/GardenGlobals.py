...
WateringCanAttributes = {
    ...
    2: {"numBoxes": 2, "skillPts": 400, "name": TTLocalizer.WateringCanLarge},
    3: {"numBoxes": 2, "skillPts": 1000, "name": TTLocalizer.WateringCanHuge},
}
WateringMult = 2
    ...
    for curWateringCan in range(wateringCan + 1):
        ...
        if wateringCanSkill >= skill:
            if curWateringCan == wateringCan:
                gardenNotify.warning(
                    "this shouldn't happen wateringCanSkill %d >= skill %d"
                    % (wateringCanSkill, skill)
                )
...
PlantAttributes = {
    49: {
        "name": TTLocalizer.FlowerSpeciesNames[49],
    ...
    50: {
        "name": TTLocalizer.FlowerSpeciesNames[50],
        "plantType": FLOWER_TYPE,
        "growthThresholds": (1, 1, 1),
        "maxWaterLevel": getMaxWateringCanPower(),
        "minWaterLevel": -2,
    ...
    51: {
        "name": TTLocalizer.FlowerSpeciesNames[51],
        "plantType": FLOWER_TYPE,
        "growthThresholds": (1, 1, 1),
        "maxWaterLevel": getMaxWateringCanPower(),
        "minWaterLevel": -2,
    ...
    52: {
        "name": TTLocalizer.FlowerSpeciesNames[52],
        "plantType": FLOWER_TYPE,
        "growthThresholds": (1, 1, 1),
        "maxWaterLevel": getMaxWateringCanPower(),
        "minWaterLevel": -2,
    ...
    53: {
        "name": TTLocalizer.FlowerSpeciesNames[53],
        "plantType": FLOWER_TYPE,
        "growthThresholds": (1, 1, 1),
        "maxWaterLevel": getMaxWateringCanPower(),
        "minWaterLevel": -2,
    ...
    54: {
        "name": TTLocalizer.FlowerSpeciesNames[54],
        "plantType": FLOWER_TYPE,
        "growthThresholds": (1, 1, 1),
        "maxWaterLevel": getMaxWateringCanPower(),
        "minWaterLevel": -2,
    ...
    55: {
        "name": TTLocalizer.FlowerSpeciesNames[55],
        "plantType": FLOWER_TYPE,
        "growthThresholds": (1, 1, 1),
        "maxWaterLevel": getMaxWateringCanPower(),
        "minWaterLevel": -2,
    ...
    56: {
        "name": TTLocalizer.FlowerSpeciesNames[56],
        "plantType": FLOWER_TYPE,
        "growthThresholds": (1, 1, 1),
        "maxWaterLevel": getMaxWateringCanPower(),
        "minWaterLevel": -1,
    ...
    200: {
        "name": TTLocalizer.StatuaryDonald,
    ...
    201: {
        "name": TTLocalizer.StatuaryMickey1,
        "plantType": STATUARY_TYPE,
    ...
    202: {
        "name": TTLocalizer.StatuaryGardenAccelerator,
        "plantType": STATUARY_TYPE,
        "model": "phase_4/models/props/goofy_statue",
        "varieties": ((1002, 1, 0),),
    },
    203: {
        "name": TTLocalizer.StatuaryMinnie,
        "plantType": STATUARY_TYPE,
    ...
    204: {
        "name": TTLocalizer.StatuaryMickey2,
        "plantType": STATUARY_TYPE,
    ...
    205: {
        "name": TTLocalizer.StatuaryToonWave,
        "plantType": STATUARY_TYPE,
    ...
    206: {
        "name": TTLocalizer.StatuaryToonVictory,
        "plantType": STATUARY_TYPE,
        "model": "phase_5.5/models/estate/garden_pedestal",
        "worldScale": 0.05,
        "varieties": ((1006, 1, 0),),
    ...
    207: {
        "name": TTLocalizer.StatuaryToonCrossedArms,
        "plantType": STATUARY_TYPE,
        "model": "phase_5.5/models/estate/garden_pedestal",
        "worldScale": 0.05,
        "varieties": ((1007, 1, 0),),
    ...
    208: {
        "name": TTLocalizer.StatuaryToonThinking,
        "plantType": STATUARY_TYPE,
        "model": "phase_5.5/models/estate/garden_pedestal",
        "worldScale": 0.05,
        "varieties": ((1008, 1, 0),),
    ...
    230: {
        "name": TTLocalizer.StatuaryMeltingSnowman,
        "plantType": STATUARY_TYPE,
    ...
    231: {
        "name": TTLocalizer.StatuaryMeltingSnowDoodle,
        "plantType": STATUARY_TYPE,
    ...
    234: {
        "name": TTLocalizer.AnimatedStatuaryFlappyCog,
        "plantType": STATUARY_TYPE,
...
for i in range(NUM_GAGS):
    ...
    if level <= 6:
        name = (
            TTLocalizer.BattleGlobalAvPropStrings[track][level]
            + TTLocalizer.GardenGagTree
        )
    else:
...
Recipes = {
    0: {"beans": "RRR", "special": -1},
    1: {"beans": "RYOY", "special": -1},
    2: {"beans": "RPOROP", "special": -1},
    3: {"beans": "RCOPVCC", "special": -1},
    4: {"beans": "RBVVBBPB", "special": -1},
    10: {"beans": "Y", "special": -1},
    11: {"beans": "YR", "special": -1},
    12: {"beans": "YRG", "special": -1},
    13: {"beans": "YRCO", "special": -1},
    14: {"beans": "YROOO", "special": -1},
    15: {"beans": "YBCVBB", "special": -1},
    16: {"beans": "YGROGGG", "special": -1},
    17: {"beans": "YBVCVROV", "special": -1},
    20: {"beans": "VRBVV", "special": -1},
    21: {"beans": "VRRRVV", "special": -1},
    22: {"beans": "VYYVYOVY", "special": -1},
    30: {"beans": "P", "special": -1},
    31: {"beans": "PY", "special": -1},
    32: {"beans": "PRR", "special": -1},
    33: {"beans": "PRGBR", "special": -1},
    34: {"beans": "PGGGGYG", "special": -1},
    40: {"beans": "C", "special": -1},
    41: {"beans": "CG", "special": -1},
    42: {"beans": "COO", "special": -1},
    43: {"beans": "COOP", "special": -1},
    44: {"beans": "CRRRR", "special": -1},
    45: {"beans": "CRVVVV", "special": -1},
    46: {"beans": "CVCBCBB", "special": -1},
    47: {"beans": "CBYYCBYY", "special": -1},
    50: {"beans": "G", "special": -1},
    51: {"beans": "GC", "special": -1},
    52: {"beans": "GPYY", "special": -1},
    53: {"beans": "GPBPP", "special": -1},
    60: {"beans": "O", "special": -1},
    61: {"beans": "OC", "special": -1},
    62: {"beans": "ORR", "special": -1},
    63: {"beans": "OYYR", "special": -1},
    64: {"beans": "OPPOBP", "special": -1},
    70: {"beans": "BVBVCBB", "special": -1},
    71: {"beans": "BPPBROYY", "special": -1},
    1000: {"beans": "GG", "special": 100},
    1001: {"beans": "SSSS", "special": 101},
    1002: {"beans": "S", "special": 102},
    1003: {"beans": "VVVVVV", "special": 103},
    1004: {"beans": "OOOOOOOO", "special": 104},
    1005: {"beans": "RRRRRRRR", "special": 105},
    1006: {"beans": "GGGGGGGG", "special": 106},
    1007: {"beans": "BBBBBBBB", "special": 107},
    1008: {"beans": "SSSSSSSS", "special": 108},
    1030: {"beans": "S", "special": 130},
    1031: {"beans": "S", "special": 131},
    1035: {"beans": "S", "special": 135},
    2001: {"beans": "ZVOVOVO", "special": -1},
    2002: {"beans": "ZOVOVOV", "special": -1},
}
...
MAX_SHOVELS = 4
ShovelAttributes = {
    0: {"numBoxes": 2, "skillPts": 80, "name": TTLocalizer.ShovelTin},
    1: {"numBoxes": 2, "skillPts": 160, "name": TTLocalizer.ShovelSteel},
    2: {"numBoxes": 2, "skillPts": 320, "name": TTLocalizer.ShovelSilver},
    3: {"numBoxes": 2, "skillPts": 640, "name": TTLocalizer.ShovelGold},
}
    ...
    for curShovel in range(shovel + 1):
        ...
        if curShovel == shovel:
            if shovelSkill >= skill:
                gardenNotify.warning(
                    "this shouldn't happen shovelSkill %d >= skill %d"
                    % (shovelSkill, skill)
                )
                shovelSkill = skill - 1
            skillPtPerBox = skill / curBoxes
...
def getFlowerVarietyName(species, variety):
    ...
    if species in list(PlantAttributes.keys()):
        ...
        if variety < len(attrib["varieties"]):
            ...
            gardenNotify.warning(
                "warning unknown species=%d variety= %d" % (species, variety)
            )
    else:
...
def validateRecipes(notify):
    ...
    for key in list(Recipes.keys()):
        ...
        if len(beans) > numBoxes:
            notify.warning(
                "numBoxes=%d beans=%s, truncating to %s"
                % (numBoxes, beans, beans[:numBoxes])
            )
...
def validatePlantAttributes(notify):
        ...
        if plant["plantType"] in (STATUARY_TYPE, FLOWER_TYPE):
            ...
            for variety in varieties:
                ...
                if plant["plantType"] == FLOWER_TYPE:
                    ...
                    newInfo = (
                        getFlowerVarietyName(key, list(varieties).index(variety)),
    ...
    for numBeans in range(len(flowerRecipeDistribution)):
        notify.debug(
            "%d flowers with %d beans"
            % (len(flowerRecipeDistribution[numBeans]), numBeans)
        )
        for flower in flowerRecipeDistribution[numBeans]:
            notify.debug(
                "    %s,  beans = %s, color=%s" % (flower[0], flower[1], flower[2])
            )
...
plots0 = (
    ...
    (4, 0, 0.0, FLOWER_TYPE),
    (4, 1, 0.0, FLOWER_TYPE),
    (-54, -13.5, 276.0, GAG_TREE_TYPE),
    (-7, -48, 343.0, GAG_TREE_TYPE),
    (-40, -75, 27.0, GAG_TREE_TYPE),
    (-78, -44, 309.0, GAG_TREE_TYPE),
    (-72, -15, 260.0, GAG_TREE_TYPE),
    (-24, -19, 294.0, GAG_TREE_TYPE),
    (11, -26, 0.0, GAG_TREE_TYPE),
    (-92, -4, 0.0, GAG_TREE_TYPE),
...
plots1 = (
    ...
    (4, 0, 0.0, FLOWER_TYPE),
    (4, 1, 0.0, FLOWER_TYPE),
    (62, -81, 194.0, GAG_TREE_TYPE),
    (101, -52, 250.0, GAG_TREE_TYPE),
    (93, -104, 214.0, GAG_TREE_TYPE),
    (69, -122, 188.0, GAG_TREE_TYPE),
    (92, -120, 184.0, GAG_TREE_TYPE),
    (113, -29, 250.0, GAG_TREE_TYPE),
    (125, -57, 0.0, GAG_TREE_TYPE),
    (114, -40, 0.0, GAG_TREE_TYPE),
...
plots2 = (
    ...
    (4, 0, 0.0, FLOWER_TYPE),
    (4, 1, 0.0, FLOWER_TYPE),
    (-40, -114, 176.0, GAG_TREE_TYPE),
    (-44, -148, 162.0, GAG_TREE_TYPE),
    (-97, -99, 138.0, GAG_TREE_TYPE),
    (-82, -94, 134.0, GAG_TREE_TYPE),
    (-27, -106, 195.0, GAG_TREE_TYPE),
    (-76, -147, 110.0, GAG_TREE_TYPE),
    (-29, -164, 0.0, GAG_TREE_TYPE),
    (-107, -94, 0.0, GAG_TREE_TYPE),
...
plots3 = (
    ...
    (4, 0, 0.0, FLOWER_TYPE),
    (4, 1, 0.0, FLOWER_TYPE),
    (59, 35, 187.0, GAG_TREE_TYPE),
    (87, 28, 114.0, GAG_TREE_TYPE),
    (67, -16, 78.0, GAG_TREE_TYPE),
    (24, 19, 155.0, GAG_TREE_TYPE),
    (18, 31, 172.0, GAG_TREE_TYPE),
    (74, 36, 133.0, GAG_TREE_TYPE),
    (35, -34, 0.0, GAG_TREE_TYPE),
    (116, 17, 0.0, GAG_TREE_TYPE),
...
plots4 = (
    ...
    (4, 0, 0.0, FLOWER_TYPE),
    (4, 1, 0.0, FLOWER_TYPE),
    (37, 101, 350.0, GAG_TREE_TYPE),
    (15, 100, 342.0, GAG_TREE_TYPE),
    (73, 92, 0.0, GAG_TREE_TYPE),
    (74, 69, 347.0, GAG_TREE_TYPE),
    (102, 62, 334.0, GAG_TREE_TYPE),
    (86, 76, 350.0, GAG_TREE_TYPE),
    (100, 78, 327.0, GAG_TREE_TYPE),
    (15, 73, 50.0, GAG_TREE_TYPE),
...
plots5 = (
    ...
    (4, 0, 0.0, FLOWER_TYPE),
    (4, 1, 0.0, FLOWER_TYPE),
    (-26, 92, 41.0, GAG_TREE_TYPE),
    (-71, 58, 37.0, GAG_TREE_TYPE),
    (-67, 21, 243.0, GAG_TREE_TYPE),
    (-10, -2.6, 178.0, GAG_TREE_TYPE),
    (-60, 13.7, 250.0, GAG_TREE_TYPE),
    (-13, 84, 2.0, GAG_TREE_TYPE),
    (-62, 65, 0.0, GAG_TREE_TYPE),
