...
class ChineseTutorial(DirectFrame, FSM.FSM):
    ...
    def enterPage1(self, *args):
        ...
        self.blinker.append(
            LerpColorInterval(obj, 0.5, Vec4(0.5, 0.5, 0, 0.0), Vec4(0.2, 0.2, 0.2, 1))
        )
        self.blinker.append(
            LerpColorInterval(obj, 0.5, Vec4(0.2, 0.2, 0.2, 1), Vec4(0.5, 0.5, 0, 0.0))
        )
        self.blinker.loop()
...
class CheckersTutorial(DirectFrame, FSM.FSM):
    ...
    def enterPage3(self, *args):
        ...
        self.blinker.append(
            LerpColorInterval(
                self.obj, 0.5, Vec4(0.5, 0.5, 0, 0.0), Vec4(0.9, 0.9, 0, 1)
            )
        )
        self.blinker.append(
            LerpColorInterval(
                self.obj, 0.5, Vec4(0.9, 0.9, 0, 1), Vec4(0.5, 0.5, 0, 0.0)
            )
        )
        self.blinker.loop()
        self.bNext.hide()
