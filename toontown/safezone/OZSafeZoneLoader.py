    ...
    def load(self):
        ...
        if self.geyserModel:
            ...
            mesh.setTexProjector(
                mesh.findTextureStage("default"), joint, self.geyserActor
            )
        ...
        self.geyserNodePath.setPos(
            self.geyserPos[0], self.geyserPos[1], self.geyserPos[2] - 100.0
        )
        ...
        if self.waterfallModel:
            ...
            mesh.setTexProjector(
                mesh.findTextureStage("default"), joint, self.waterfallActor
            )
    ...
    def setGeyserAnim(self, task=None):
            ...
            if distance < 7.0:
                ...
                if av == base.localAvatar:
                    ...
                    topTrack.delayDeletes = [
                        DelayDelete.DelayDelete(av, "OZSafeZoneLoader.setGeyserAnim")
                    ]
                    av.stopSmooth()
                animTrack = Parallel()
                toonTrack = Sequence()
                ...
                animTrack.append(
                    ActorInterval(av, "jump-idle", loop=1, endTime=11.5 * time)
                )
                animTrack.append(
        ...
        self.geyserTrack.append(
            Parallel(
                ...
                LerpPosInterval(
                    self.geyserActor, 2.0 * time, pos=downPos, startPos=downPos
                ),
            )
        )
        self.geyserTrack.append(
        ...
        self.geyserTrack.append(
            Parallel(
                ...
                LerpPosInterval(
                    self.geyserActor, 2.0 * time, pos=downPos, startPos=upPos
                ),
            )
        )
        self.geyserTrack.append(
        ...
        self.geyserTrack.append(
            Parallel(
                ...
                LerpPosInterval(
                    self.geyserActor, 4.0 * time, pos=downPos, startPos=upPos
                ),
            )
        )
        self.geyserTrack.append(
