...
baseScheme = {'TI_wainscotting': wainscottingBase,
 ...
 'TI_door': doorBase,
 'TI_floor': floorBase}
colors = {RainbowRise: {'TI_wainscotting': wainscottingBase,
               'TI_wallpaper': wallpaperBase,
               'TI_wallpaper_border': wallpaperBorderBase,
               'TI_door': doorBase,
               'TI_floor': floorBase},
 ToonIslandCentral: {'TI_wainscotting': wainscottingBase,
                   'TI_wallpaper': wallpaperBase,
                   'TI_wallpaper_border': wallpaperBorderBase,
                   'TI_door': doorBase + [Vec4(0.8, 0.5, 0.3, 1.0)],
                   'TI_floor': floorBase},
 CirrusCircus: baseScheme,
 OliveOasis: baseScheme,
 WitheringWoods: baseScheme,
 GoofySpeedway: baseScheme,
 MintyMines: {'TI_wainscotting': wainscottingBase,
                    'TI_wallpaper': wallpaperBase,
                    'TI_wallpaper_border': wallpaperBorderBase,
                    'TI_door': doorBase,
                    'TI_floor': floorBase},
