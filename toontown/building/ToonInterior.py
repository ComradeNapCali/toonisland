    ...
    def __init__(self, loader, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                ...
                State.State(
                    "teleportIn", self.enterTeleportIn, self.exitTeleportIn, ["walk"]
                ),
                State.State(
                    "teleportOut",
                ...
                State.State(
                    "quest", self.enterQuest, self.exitQuest, ["walk", "doorOut"]
                ),
                State.State(
                    "tutorial", self.enterTutorial, self.exitTutorial, ["walk", "quest"]
                ),
                State.State(
                    "purchase",
                    self.enterPurchase,
                ...
                State.State(
                    "phone", self.enterPhone, self.exitPhone, ["walk", "doorOut"]
                ),
                State.State(
                    "stopped", self.enterStopped, self.exitStopped, ["walk", "doorOut"]
                ),
