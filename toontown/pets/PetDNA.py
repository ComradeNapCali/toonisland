...
HeadParts = ["feathers"]
EarParts = ["horns", "antennae", "dogEars", "catEars", "rabbitEars"]
EarTextures = {
    "horns": None,
    "antennae": None,
    "dogEars": None,
...
GenericBodies = ["dots", "threeStripe", "tigerStripe", "tummy"]
...
PetRarities = {
    "body": {
        ToontownGlobals.ToonIslandCentral: {"threeStripe": 50, "tummy": 30, "dots": 20},
...
def getRandomPetDNA(zoneId=ToontownGlobals.MintyMines):
