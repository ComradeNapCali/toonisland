...
PetRarities = {'body': {ToontownGlobals.ToonIslandCentral: {'threeStripe': 50,
          ...
          ToontownGlobals.RainbowRise: {'threeStripe': 35,
                                        ...
                                        'dots': 20,
                                        'tigerStripe': 15},
          ToontownGlobals.WitheringWoods: {'threeStripe': 15,
                                         'tummy': 20,
                                         'dots': 20,
                                         'tigerStripe': 20,
                                         'turtle': 15},
          ToontownGlobals.OliveOasis: {'threeStripe': 10,
                                              'tummy': 15,
                                              'dots': 30,
                                              'tigerStripe': 25,
                                              'turtle': 20},
          ToontownGlobals.CirrusCircus: {'threeStripe': 5,
                                      'tummy': 10,
                                      'dots': 20,
                                      'tigerStripe': 25,
                                      'turtle': 25,
                                      'giraffe': 15},
          ToontownGlobals.MintyMines: {'threeStripe': 5,
                                             'tummy': 5,
                                             'dots': 15,
                                             'tigerStripe': 20,
                                             'turtle': 25,
