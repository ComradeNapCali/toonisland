...
class Door(Nodepath):
    ...
    attribs = (
        ...
        ("isVisBlocker", 1, "bool"),
        ("unlock0Event", 0, "entId", {"output": "bool"}),
        ("unlock1Event", 0, "entId", {"output": "bool"}),
        ("unlock2Event", 0, "entId", {"output": "bool"}),
        ("unlock3Event", 0, "entId", {"output": "bool"}),
...
class Crusher(Nodepath):
    abstract = 1
    attribs = (("crushCellId", None, "entId", {"type": "crusherCell"}),)
...
class Goon(Crushable):
    type = "goon"
    attribs = (
        ("goonType", "pg", "choice", {"choiceSet": ["pg", "sg"]}),
        ("strength", 5, "int", {"min": 0, "max": 105}),
        ("velocity", 4, "float", {"min": 0, "max": 10}),
        ("attackRadius", 15, "float", {"min": 1, "max": 20}),
        ("scale", 1.5, "float"),
        ("hFov", 70, "float", {"min": 0, "max": 179}),
    )
...
class GoonClipPlane(Nodepath):
    type = "goonClipPlane"
    attribs = (("goonId", None, "entId", {"type": "goon"}),)
...
class DirectionalCell(ActiveCell):
    ...
    attribs = (
        (
            ...
            {
                "choiceSet": ["l", "r", "up", "dn"],
                "valueDict": {"l": [-1, 0], "r": [1, 0], "up": [0, 1], "dn": [0, -1]},
            },
        ),
    )
...
class LaserField(Nodepath):
    ...
    attribs = (
        ...
        (
            ...
            0,
            "choice",
            {"choiceSet": ["square"], "valueDict": {"square": 0}},
        ),
        ("pos", Point3(0, 0, 0), "pos"),
        ("hpr", Vec3(0, 0, 0), "hpr"),
        ("cellId", 0, "int"),
        ...
        (
            ...
            "Random",
            "choice",
            {"choiceSet": ["MineSweeper", "Roll", "Avoid", "Random"]},
        ),
    )
...
class SecurityCamera(Nodepath):
    ...
    attribs = (
        ...
        ("hpr", Vec3(0, 0, 0), "hpr"),
        ("switchId", 0, "entId", {"type": "button"}),
        ("trackTarget1", 0, "entId", {"type": "button"}),
        ("trackTarget2", 0, "entId", {"type": "button"}),
        ("trackTarget3", 0, "entId", {"type": "button"}),
    )
...
class Lift(Nodepath):
    ...
    attribs = (
        ...
        ("endGuardName", "", "string"),
        ("startBoardSides", ["front", "back", "left", "right"]),
        ("endBoardSides", ["front", "back", "left", "right"]),
        ("moveDelay", 1, "float", {"min": 0}),
        ("autoMoveDelay", 5, "float", {"min": 0}),
    )
...
class Mover(Nodepath):
    ...
    attribs = (
        ...
        ("hpr", Vec3(0, 0, 0), "hpr"),
        ("switchId", 0, "entId", {"type": "button"}),
        ("entity2Move", 0, "entId", {"type": "button"}),
        ("moveTarget", 0, "entId", {"type": "button"}),
        ("pos0Move", 2, "float"),
        ("pos0Wait", 2, "float"),
        ("pos1Move", 2, "float"),
        ("pos1Wait", 2, "float"),
        ...
        (
            ...
            "return",
            "choice",
            {"choiceSet": ["return", "linear", "loop", "oneWay"]},
        ),
    )
...
class Platform(Nodepath):
    ...
    attribs = (
        ...
        (
            ...
            "noBlend",
            "choice",
            {"choiceSet": ["noBlend", "easeInOut", "easeIn", "easeOut"]},
        ),
    )
...
class Stomper(Crusher):
    ...
    attribs = (
        ("damage", 3, "int"),
        ("style", "vertical", "choice", {"choiceSet": ["horizontal", "vertical"]}),
        ("period", 2.0, "float"),
        ("phaseShift", 0.0, "float", {"min": 0, "max": 1}),
        ("range", 6, "float"),
        (
        ...
        (
            ...
            "choice",
            {
                ...
                "valueDict": {"small": 0, "medium": 1, "large": 2},
            },
        ),
        ("soundLen", 0, "float"),
        ("zOffset", 0, "float"),
...
class StomperPair(Nodepath):
    ...
    attribs = (
        ...
        ("style", "horizontal", "choice", {"choiceSet": ["horizontal", "vertical"]}),
    )
...
class Gear(Nodepath):
    type = "gear"
    attribs = (
        ("modelType", "factory", "choice", {"choiceSet": ["factory", "mint"]}),
        ("gearScale", 1, "float"),
        (
            "orientation",
            "horizontal",
...
class PaintMixer(Platform):
    type = "paintMixer"
    attribs = (
        ("modelPath", "phase_9/models/cogHQ/PaintMixer", "const"),
        ("floorName", "PaintMixerFloorCollision", "const"),
        ("shaftScale", 1, "float"),
    )
    ...
    attribs = (
        (
            ...
            "choice",
            {
                ...
                "valueDict": {"coin": 12500, "dollar": 12600, "bullion": 12700},
            },
        ),
    )
...
class PathMaster(Nodepath):
    ...
    attribs = (
        ("pathIndex", 0, "int"),
        ("pathScale", 1.0, "float"),
        ("pathTarget0", 0, "entId", {"type": "button"}),
        ("pathTarget1", 0, "entId", {"type": "button"}),
        ("pathTarget2", 0, "entId", {"type": "button"}),
        ("pathTarget3", 0, "entId", {"type": "button"}),
        ("pathTarget4", 0, "entId", {"type": "button"}),
        ("pathTarget5", 0, "entId", {"type": "button"}),
        ("pathTarget6", 0, "entId", {"type": "button"}),
        ("pathTarget7", 0, "entId", {"type": "button"}),
    )
