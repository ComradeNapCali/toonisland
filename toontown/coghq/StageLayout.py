...
def printRoomInfo():
    ...
    for roomId in roomIds:
        print(
            "room %s: %s cogs, %s cogLevels, %s merit cogLevels"
            % (
                roomId,
...
LawOfficeLayout2_0 = [(0, 7, 8, 105, 1), (0, 10, 104, 103, 1), (0, 105, 101, 12, 2)]
LawOfficeLayout2_1 = [(0, 10, 11, 104, 1), (0, 100, 105, 8, 1), (0, 103, 3, 104, 2)]
LawOfficeLayout2_2 = [(0, 8, 105, 102, 1), (0, 100, 104, 10, 1), (0, 101, 105, 3, 2)]
LawOfficeLayout3_0 = [
    (0, 8, 101, 104, 1),
    (0, 7, 105, 103, 1),
    (0, 100, 8, 104, 1),
...
class StageLayout:
    ...
    def __str__(self):
        return (
            "StageLayout: id=%s, layout=%s, floor=%s, meritCogLevels=%s, numRooms=%s, numBattles=%s, numCogs=%s"
            % (
                self.stageId,
                self.layoutId,
                self.floorNum,
