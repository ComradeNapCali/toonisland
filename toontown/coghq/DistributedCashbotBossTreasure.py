...
Models = {
    ToontownGlobals.ToonIslandCentral: "phase_4/models/props/icecream",
    ToontownGlobals.RainbowRise: "phase_6/models/props/starfish_treasure",
    ToontownGlobals.CirrusCircus: "phase_8/models/props/snowflake_treasure",
    ToontownGlobals.OliveOasis: "phase_6/models/props/music_treasure",
    ToontownGlobals.WitheringWoods: "phase_8/models/props/flower_treasure",
    ToontownGlobals.MintyMines: "phase_8/models/props/zzz_treasure",
}
    ...
    def setFinalPosition(self, x, y, z):
        ...
        self.treasureFlyTrack = Sequence(
            ...
            Parallel(
                ...
                LerpPosInterval(
                    self.nodePath, lerpTime, Point3(x, y, z), startPos=startPos
                ),
            ),
