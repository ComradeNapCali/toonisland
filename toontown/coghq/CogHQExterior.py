...
class CogHQExterior(BattlePlace.BattlePlace):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                ...
                State.State(
                    "doorIn", self.enterDoorIn, self.exitDoorIn, ["walk", "stopped"]
                ),
                State.State(
                    "doorOut", self.enterDoorOut, self.exitDoorOut, ["walk", "stopped"]
                ),
                State.State(
                    "stickerBook",
    ...
    def enterSquished(self):
        ...
        taskMgr.doMethodLater(
            2.0, self.handleSquishDone, base.localAvatar.uniqueName("finishSquishTask")
        )
