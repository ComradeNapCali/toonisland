        ...
        self.privRegisterTypes(
            {
                ...
                "beanBarrel": Functor(
                    cDE, DistributedBeanBarrelAI.DistributedBeanBarrelAI
                ),
                ...
                "rendering": nothing,
                "platform": nothing,
                "sinkingPlatform": Functor(
                    cDE, DistributedSinkingPlatformAI.DistributedSinkingPlatformAI
                ),
                "stomper": Functor(cDE, DistributedStomperAI.DistributedStomperAI),
                "stomperPair": Functor(
                    cDE, DistributedStomperPairAI.DistributedStomperPairAI
                ),
                "laserField": Functor(
                    cDE, DistributedLaserFieldAI.DistributedLaserFieldAI
                ),
                "securityCamera": Functor(
                    cDE, DistributedSecurityCameraAI.DistributedSecurityCameraAI
                ),
                "elevatorMarker": Functor(
                    cDE, DistributedElevatorMarkerAI.DistributedElevatorMarkerAI
                ),
                "trigger": DistributedTriggerAI.DistributedTriggerAI,
                "moleField": Functor(
                    cDE, DistributedMoleFieldAI.DistributedMoleFieldAI
                ),
