...
GlobalEntities = {
    1000: {
        ...
        "parentEntId": 0,
        "cogLevel": 0,
        "farPlaneDistance": 2200.0,
        "modelFilename": "phase_9/models/cogHQ/SellbotFatalFactory",
        "wantDoors": 1,
    },
    0: {
        "type": "zone",
    ...
    11: {
        ...
        "visibility": [10, 111, 112, 200, 223, 224, 225, 227],
    },
    12: {
        "type": "zone",
    ...
    223: {
        "type": "zone",
        "name": "dwFatalFactEcatwalk",
        "comment": "",
        "parentEntId": 0,
        "scale": 1,
        "description": TTLocalizer.SellbotLegFactorySpecFatalFactoryEastCatWalk,
        "visibility": [11, 41, 53, 200, 224, 225, 226, 227, 228, 229, 230, 232, 234],
    },
    226: {
        "type": "zone",
        "name": "Fatalfact1",
        ...
        "parentEntId": 0,
        "scale": 1,
        "description": TTLocalizer.SellbotLegFactorySpecFatalFact1,
        "visibility": [200, 223, 225, 227, 229],
    },
    227: {
        "type": "zone",
        "name": "Fatalfact1Exterior",
        "comment": "",
        "parentEntId": 0,
        "scale": 1,
        "description": "",
    ...
    230: {
        ...
        "parentEntId": 0,
        "scale": 1,
        "description": TTLocalizer.SellbotLegFactoryFatalLavaRoom,
        "visibility": [200, 223, 225, 227, 228, 230, 231],
    },
    231: {
        "type": "zone",
        "name": "Fatalfact2",
        ...
        "parentEntId": 0,
        "scale": 1,
        "description": TTLocalizer.SellbotLegFactoryFatalFact2,
        "visibility": [200, 223, 225, 227, 228, 230, 231],
    },
    234: {
        "type": "zone",
        ...
        "parentEntId": 0,
        "scale": 1,
        "description": TTLocalizer.SellbotLegFactoryFatalLavaRoom2,
        "visibility": [200, 223, 225, 227, 232, 233, 234],
    },
    233: {
        "type": "zone",
        "name": "Fatalfact3",
        ...
        "parentEntId": 0,
        "scale": 1,
        "description": TTLocalizer.SellbotLegFactoryFatalFact3,
        "visibility": [200, 223, 225, 227, 232, 233, 234],
    },
    101: {
        "type": "zone",
    ...
    61000: {
        ...
        "comment": "",
        "parentEntId": 226,
        "pos": Point3(-56.596, 63.015, 15.075),
        "hpr": Vec3(0, 0, 0),
        "scale": Point3(5.5, 5.5, 4.5),
        "color": Vec4(0, 0, 1, 1),
        "isOn": 0,
    ...
    61001: {
        ...
        "comment": "",
        "parentEntId": 226,
        "pos": Point3(55.013, 63.550, 15.075),
        "hpr": Point3(0, 0, 0),
        "scale": Point3(5.5, 5.5, 4.5),
        "color": Vec4(0, 0, 1, 1),
        "isOn": 0,
    ...
    10005: {
        ...
        "comment": "",
        "parentEntId": 10000,
        "pos": Point3(0, 42.2024, 7.24937),
        "hpr": Point3(180, 0, 0),
        "scale": 1,
        "floorName": "platformcollision",
        "length": 74.81881352704218,
        "speed": 2.0,
        "treadLength": 10.0,
    ...
    10049: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 3},
    10051: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 4},
    60000: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 5},
    60001: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 6},
    60002: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 7},
    60003: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 9},
    60004: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 10},
    60005: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 8},
    60006: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 21},
    60007: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 24},
    60009: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 38},
    60011: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 12},
    60013: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 13},
    60014: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 14},
    60015: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 17},
    60016: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 15},
    60017: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 16},
    60018: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 19},
    60019: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 18},
    60024: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 22},
    60031: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 23},
    60044: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 33},
    60066: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 11},
    60067: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 27},
    60096: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 30},
    60108: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 34},
    60111: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 36},
    60114: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 37},
    60121: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 31},
    60126: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 35},
    60130: {"type": "entityGroup", "name": "viz", "comment": "", "parentEntId": 32},
    10028: {
        "type": "entrancePoint",
        "name": "entrance2",
        "comment": "",
    ...
    22000: {
        ...
        "comment": "",
        "parentEntId": 226,
        "pos": Point3(42.882, -36.454, 13.75),
        "hpr": Vec3(-60, 0, 0),
        "scale": 1,
        "gagLevel": 5,
        "gagTrack": 3,
    ...
    22001: {
        ...
        "comment": "",
        "parentEntId": 226,
        "pos": Point3(-43.627, -34.091, 13.75),
        "hpr": Vec3(60, 0, 0),
        "scale": 1,
        "gagLevel": 5,
        "gagTrack": 4,
    ...
    22002: {
        ...
        "comment": "",
        "parentEntId": 226,
        "pos": Point3(-0.362, 69.753, 10.025),
        "hpr": Vec3(0, 0, 0),
        "scale": 1,
        "rewardPerGrab": 25,
        "rewardPerGrabMax": 0,
    ...
    22003: {
        ...
        "comment": "",
        "parentEntId": 226,
        "pos": Point3(59.309, 20.467, -4.925),
        "hpr": Vec3(0, 0, 0),
        "scale": 1.5,
        "rewardPerGrab": 350,
        "rewardPerGrabMax": 0,
    ...
    22004: {
        ...
        "comment": "",
        "parentEntId": 230,
        "pos": Point3(35.968, -38.754, -4.968),
        "hpr": Vec3(-140, 0, 0),
        "scale": 1,
        "gagLevel": 5,
        "gagTrack": 3,
    ...
    22005: {
        ...
        "comment": "",
        "parentEntId": 230,
        "pos": Point3(29.945, 49.639, -30.781),
        "hpr": Vec3(-140, 0, 0),
        "scale": 1,
        "gagLevel": 5,
        "gagTrack": 1,
    ...
    22006: {
        ...
        "comment": "",
        "parentEntId": 230,
        "pos": Point3(46.749, -95.709, 8.955),
        "hpr": Vec3(-145, 0, 0),
        "scale": 1,
        "rewardPerGrab": 200,
        "rewardPerGrabMax": 0,
    ...
    22007: {
        ...
        "comment": "",
        "parentEntId": 230,
        "pos": Point3(-43.341, 57.254, -30.782),
        "hpr": Vec3(90, 0, 0),
        "scale": 1,
        "rewardPerGrab": 50,
        "rewardPerGrabMax": 0,
    ...
    22008: {
        ...
        "comment": "",
        "parentEntId": 231,
        "pos": Point3(23.703, 17.840, 0.223),
        "hpr": Vec3(-60, 0, 0),
        "scale": 1,
        "gagLevel": 5,
        "gagTrack": 3,
    ...
    22009: {
        ...
        "comment": "",
        "parentEntId": 231,
        "pos": Point3(28.432, 10.259, 0.223),
        "hpr": Vec3(-60, 0, 0),
        "scale": 1,
        "gagLevel": 5,
        "gagTrack": 6,
    ...
    10065: {
        ...
        "comment": "",
        "parentEntId": 10000,
        "pos": Point3(0, 60.7652, 0),
        "hpr": Point3(0, 0, 0),
        "scale": Point3(1.5, 1.9, 0.73),
    },
    10067: {
        "type": "nodepath",
        "name": "frontSteps",
        "comment": "",
        "parentEntId": 10000,
        "pos": Point3(0, -50.7196, 0),
        "hpr": Point3(180, 0, 0),
        "scale": Point3(1.5, 1.9, 0.729057),
    },
    10068: {
        "type": "nodepath",
        "name": "battleCell",
    ...
    11012: {
        ...
        "comment": "",
        "parentEntId": 11010,
        "pos": Point3(-8.85419, -87.75751, 26.5836),
        "hpr": Vec3(-172, 0, 0),
        "scale": 1,
        "floorName": "PaintMixerFloorCollision",
        "modelPath": "phase_9/models/cogHQ/PaintMixer",
        "modelScale": Point3(0.8, 0.8, 0.8),
        "motion": "easeInOut",
        "offset": Point3(-8.85419, -90.75751, -40),
        "period": 8.0,
        "phaseShift": 0.0,
        "shaftScale": 9.5,
        "waitPercent": 0.1,
