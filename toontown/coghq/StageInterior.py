...
class StageInterior(BattlePlace.BattlePlace):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                ...
                State.State(
                    "sit", self.enterSit, self.exitSit, ["walk", "died", "teleportOut"]
                ),
                State.State(
                    "push",
                    self.enterPush,
    ...
    def enter(self, requestStatus):
        ...
        self.acceptOnce(
            DistributedStage.DistributedStage.WinEvent, self.handleStageWinEvent
        )
        if __debug__ and 0:
            self.accept(
                "f10",
                lambda: messenger.send(DistributedStage.DistributedStage.WinEvent),
            )
