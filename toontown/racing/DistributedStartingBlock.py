...
class DistributedStartingBlock(DistributedObject.DistributedObject, FSM):
    ...
    def bulkLoad(self):
        base.loader.beginBulkLoad('atRace', TTLocalizer.StartingBlock_Loading, 60, 1, TTLocalizer.TIP_KARTING, 15000)
