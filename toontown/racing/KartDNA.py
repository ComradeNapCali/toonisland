...
AccessoryDict = {
    ...
    40: (aNames[5000], "phase_6/maps/kart_Rim_1", InvalidEntry, "kart_Rim_1"),
    41: (aNames[5001], "phase_6/maps/kart_Rim_2", 450, "kart_Rim_2"),
    42: (aNames[5002], "phase_6/maps/kart_Rim_3", 100, "kart_Rim_3"),
    43: (aNames[5003], "phase_6/maps/kart_Rim_4", 800, "kart_Rim_4"),
    44: (aNames[5004], "phase_6/maps/kart_Rim_5", 100, "kart_Rim_5"),
    45: (aNames[5005], "phase_6/maps/kart_Rim_6", 200, "kart_Rim_6"),
    46: (aNames[5006], "phase_6/maps/kart_Rim_7", 200, "kart_Rim_7"),
    47: (aNames[5007], "phase_6/maps/kart_Rim_8", 200, "kart_Rim_8"),
    48: (aNames[5008], "phase_6/maps/kart_Rim_9", 200, "kart_Rim_9"),
    49: (aNames[5009], "phase_6/maps/kart_Rim_10", 200, "kart_Rim_10"),
    50: (aNames[5010], "phase_6/maps/kart_Rim_11", 200, "kart_Rim_11"),
    51: (aNames[5011], "phase_6/maps/kart_Rim_12", 800, "kart_Rim_12"),
    52: (aNames[5012], "phase_6/maps/kart_Rim_13", 450, "kart_Rim_13"),
    53: (aNames[5013], "phase_6/maps/kart_Rim_14", 1250, "kart_Rim_14"),
    54: (aNames[5014], "phase_6/maps/kart_Rim_15", 5000, "kart_Rim_15"),
    55: (aNames[6000], 1, 200, "%s_SideDecal_1"),
    56: (aNames[6001], 2, 450, "%s_SideDecal_2"),
    57: (aNames[6002], 3, 100, "%s_SideDecal_3"),
    58: (aNames[6003], 4, 5000, "%s_SideDecal_4"),
    59: (aNames[6004], 5, 200, "%s_SideDecal_5"),
    60: (aNames[6005], 6, 200, "%s_SideDecal_6"),
    61: (aNames[6006], 7, 450, "%s_SideDecal_7"),
    62: (aNames[6007], 8, 100, "%s_SideDecal_8"),
    63: (aNames[6008], 9, 1250, "%s_SideDecal_9"),
    64: (aNames[6009], 10, 800, "%s_SideDecal_10"),
