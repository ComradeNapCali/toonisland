...
class DistributedLeaderBoard(DistributedObject.DistributedObject):
    ...
    def announceGenerate(self):
        ...
        self.accept(
            "decorator-holiday-%d-ending" % ToontownGlobals.CRASHED_LEADERBOARD,
            self.showLists,
        )
        self.accept(
            "decorator-holiday-%d-starting" % ToontownGlobals.CRASHED_LEADERBOARD,
            self.hideLists,
        )
    ...
    def setDisplay(self, trackName, recordTitle, scores):
    ...
    def display(
        self, pTrackTitle="Track Title", pPeriodTitle="Period Title", pLeaderList=[]
    ):
