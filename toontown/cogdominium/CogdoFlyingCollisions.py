...
class CogdoFlyingCollisions(GravityWalker):
    ...
    def initializeCollisions(
        ...
        GravityWalker.initializeCollisions(
            self, collisionTraverser, avatarNodePath, avatarRadius, floorOffset, reach
        )
        return
    ...
    def setupEventSphere(self, bitmask, avatarRadius):
        ...
        cSphere = CollisionSphere(
            0.0, 0.0, self.avatarRadius + 0.75, self.avatarRadius * 1.04
        )
    ...
    def setCollisionsActive(self, active=1):
        if self.collisionsActive != active:
            ...
            if self.cFloorEventSphereNodePath != None:
                ...
                if active:
                    base.cTrav.addCollider(
                        self.cFloorEventSphereNodePath, self.floorCollisionEvent
                    )
