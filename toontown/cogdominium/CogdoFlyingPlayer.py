...
class CogdoFlyingPlayer(FSM):
    ...
    def createPropeller(self):
        ...
        for part in parts:
            ...
            backpackHeight = (
                ToontownGlobals.torsoHeightDict[self.toon.style.torso] * bodyScale - 0.5
            )
    ...
    def initIntervals(self):
        ...
        self.propellerSpinLerp = LerpFunctionInterval(
            ...
            name="%s.propellerSpinLerp-%s" % (self.__class__.__name__, self.toon.doId),
        )
        ...
        self.pulseBubbleSeq = Parallel(
            ...
            LerpHprInterval(
                self.redTapeRing, pulseTime, Vec3(360, 0, 0), startHpr=Vec3(0, 0, 0)
            ),
        ...
        self.popUpBubbleLerp = LerpScaleInterval(
            self.redTapeRing,
            scaleTime,
            scale * bouncePercent,
            startScale=0.0,
        ...
        self.popUpBubbleSeq = Sequence(
            Func(self.updateLerpStartScale, self.popUpBubbleLerp, self.redTapeRing),
