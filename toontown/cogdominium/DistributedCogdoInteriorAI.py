...
from toontown.suit import SuitDNA as SuitDNAGlobals
...
class DistributedCogdoInteriorAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def __init__(self, air, elevator):
        ...
        self.SummonID = self.chooseSummonID()
    ...
    def chooseSummonID(self) -> str:
        return random.choice(list(SuitBattleGlobals.SuitAttributes.keys()))
