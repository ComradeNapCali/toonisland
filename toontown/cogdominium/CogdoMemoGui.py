...
class CogdoMemoGui(DirectFrame):
    def __init__(self, parent, guiType="joke_card"):
    ...
    def _initModel(self, guiType="joke_card"):
        ...
        self._memoIcon = CogdoUtil.loadModel(guiType, game="shared", group="gui")
