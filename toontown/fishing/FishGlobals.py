...
__fishDict = {
    0: (
        (1, 3, 1, (Anywhere,)),
        (1, 1, 4, (TTG.ToonIslandCentral, Anywhere)),
        (3, 5, 5, (TTG.PineapplePlace, TTG.CirrusCircus)),
        (3, 5, 3, (TTG.BeachballBoulevard, TTG.WitheringWoods)),
        (1, 5, 2, (TTG.AlohaAvenue, TTG.ToonIslandCentral)),
    ),
    2: (
        (2, 6, 1, (TTG.WitheringWoods, Anywhere)),
        (2, 6, 9, (TTG.WillowWay, TTG.WitheringWoods)),
        (5, 11, 4, (TTG.RoackyRoad,)),
        (2, 6, 3, (TTG.WitheringWoods, TTG.MyEstate)),
        (5, 11, 2, (TTG.MintyMines, TTG.MyEstate)),
    ),
    4: (
        (2, 8, 1, (TTG.ToonIslandCentral, Anywhere)),
        (2, 8, 4, (TTG.ToonIslandCentral, Anywhere)),
        (2, 8, 2, (TTG.ToonIslandCentral, Anywhere)),
        (2, 8, 6, (TTG.ToonIslandCentral, TTG.OliveOasis)),
    ),
    6: ((8, 12, 1, (TTG.CirrusCircus,)),),
    8: (
        (1, 5, 1, (Anywhere,)),
        (2, 6, 2, (TTG.OliveOasis, Anywhere)),
        (5, 10, 5, (TTG.OliveOasis, Anywhere)),
        (1, 5, 7, (TTG.MyEstate, Anywhere)),
        (1, 5, 10, (TTG.MyEstate, Anywhere)),
    ),
    10: ((6, 10, 9, (TTG.MyEstate, Anywhere)),),
    12: (
        (7, 15, 1, (TTG.RainbowRise, Anywhere)),
        (18, 20, 6, (TTG.RainbowRise, TTG.MyEstate)),
        (1, 5, 5, (TTG.RainbowRise, TTG.MyEstate)),
        (3, 7, 4, (TTG.RainbowRise, TTG.MyEstate)),
        (1, 2, 2, (TTG.RainbowRise, Anywhere)),
    ),
    14: (
        (2, 6, 1, (TTG.WitheringWoods, TTG.MyEstate, Anywhere)),
        (2, 6, 3, (TTG.WitheringWoods, TTG.MyEstate)),
    ),
    16: (
        (4, 12, 5, (TTG.OliveOasis, Anywhere)),
        (4, 12, 7, (TTG.TumbleweedTerrace, TTG.OliveOasis)),
        (4, 12, 8, (TTG.CactusCourt, TTG.OliveOasis)),
    ),
    18: (
        (2, 4, 3, (TTG.RainbowRise, Anywhere)),
        (5, 8, 7, (TTG.CirrusCircus,)),
        (4, 6, 8, (TTG.PlanktonPath,)),
    ),
    20: (
        (4, 6, 1, (TTG.MintyMines,)),
        (14, 18, 10, (TTG.MintyMines,)),
        (6, 10, 8, (TTG.RoackyRoad,)),
        (1, 1, 3, (TTG.MintyMines,)),
        (2, 6, 6, (TTG.RoackyRoad,)),
        (10, 14, 4, (TTG.MintyMines, TTG.WitheringWoods)),
    ),
    22: (
        (12, 16, 2, (TTG.MyEstate, TTG.WitheringWoods, Anywhere)),
        (14, 18, 3, (TTG.MyEstate, TTG.WitheringWoods, Anywhere)),
        (14, 20, 5, (TTG.MyEstate, TTG.WitheringWoods)),
        (14, 20, 7, (TTG.MyEstate, TTG.WitheringWoods)),
    ),
    24: (
        (9, 11, 3, (Anywhere,)),
        (8, 12, 5, (TTG.WitheringWoods, TTG.RainbowRise)),
        (8, 12, 6, (TTG.WitheringWoods, TTG.RainbowRise)),
        (8, 16, 7, (TTG.WitheringWoods, TTG.RainbowRise)),
    ),
    26: (
        (10, 18, 2, (TTG.CirrusCircus,)),
        (10, 18, 3, (TTG.CirrusCircus,)),
        (10, 18, 4, (TTG.CirrusCircus,)),
        (10, 18, 5, (TTG.CirrusCircus,)),
        (12, 20, 6, (TTG.CirrusCircus,)),
        (14, 20, 7, (TTG.CirrusCircus,)),
        (14, 20, 8, (TTG.SleetStreet, TTG.CirrusCircus)),
        (16, 20, 10, (TTG.DoodleDrive, TTG.CirrusCircus)),
    ),
    28: (
        (2, 10, 2, (TTG.RainbowRise, Anywhere)),
        (4, 10, 6, (TTG.CoralCourt, TTG.RainbowRise)),
        (4, 10, 7, (TTG.OceanOverpass, TTG.RainbowRise)),
    ),
    30: (
        (13, 17, 5, (TTG.OliveOasis, Anywhere)),
        (16, 20, 10, (TTG.DesertDrive, TTG.OliveOasis)),
        (12, 18, 9, (TTG.CactusCourt, TTG.OliveOasis)),
        (12, 18, 6, (TTG.OliveOasis,)),
        (12, 18, 7, (TTG.OliveOasis,)),
    ),
    32: (
        (1, 5, 2, (TTG.ToonIslandCentral, TTG.MyEstate, Anywhere)),
        (1, 5, 3, (TTG.CirrusCircus, TTG.MyEstate, Anywhere)),
        (1, 5, 4, (TTG.WitheringWoods, TTG.SeashellStreet, TTG.MyEstate)),
        (1, 5, 5, (TTG.MintyMines, TTG.MyEstate)),
        (1, 5, 10, (TTG.CirrusCircus, TTG.MintyMines)),
    ),
    34: ((1, 20, 10, (TTG.MintyMines, Anywhere)),),
}
...
__rodDict = {0: (0, 4, 1), 1: (0, 8, 2), 2: (0, 12, 3), 3: (0, 16, 4), 4: (0, 20, 5)}
...
def getValue(genus, species, weight):
    ...
    if hasattr(base, "cr") and base.cr:
        if hasattr(base.cr, "newsManager") and base.cr.newsManager:
            ...
            if (
                ToontownGlobals.JELLYBEAN_FISHING_HOLIDAY in holidayIds
                or ToontownGlobals.JELLYBEAN_FISHING_HOLIDAY_MONTH in holidayIds
            ):
        ...
        or ToontownGlobals.JELLYBEAN_FISHING_HOLIDAY_MONTH
        in simbase.air.holidayManager.currentHolidays
    ):
        finalValue *= JellybeanFishingHolidayScoreMultiplier
    return finalValue
