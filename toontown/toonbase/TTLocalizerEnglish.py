...
QuestsDefaultIncompleteWrongNPC = (
    "Nice work on that ToonTask. You should go visit _toNpcName_._where_",
...
QuestsDefaultReject = (
    ...
    "If you recapture a "
    + Cog
    + " building, go back inside to see a special thank-you from its owner!",
    ...
    "If a "
    + Cog
    + " is stunned, it is more difficult for them to avoid falling objects.",
    "Each kind of " + Cog + " building has a distinct look.",
    "Defeating "
    + Cogs
    + " on the higher floors of a building will give you greater skill rewards.",
)
...
QuestsCogOldNewbieQuestObjective = (
    "Help a Toon with %(laffPoints)d Laff or less defeat %(objective)s"
)
...
QuestsRescueOldNewbieQuestObjective = (
    "Help a Toon with %(laffPoints)d Laff or less rescue %(objective)s"
)
...
QuestsCogPartOldNewbieQuestObjective = (
    "Help a Toon with %(laffPoints)d Laff or less retrieve %(objective)s"
)
...
QuestsDeliverGagQuestInstructions = (
...
QuestsRecoverItemQuestReturnToHQSCString = (
    "I need to return %s to an " + lHQOfficerM + "."
)
...
QuestsRecoverItemQuestRecoverFromSCString = (
    "I need to recover %(item)s from %(holder)s%(loc)s."
)
...
QuestsTrackProgressReward = (
    "You now have frame %(frameNum)s of the %(trackName)s track animation."
)
QuestsTrackProgressRewardPoster = (
    'Reward: "%(trackName)s" track animation frame %(frameNum)s'
)
...
QuestsLocationParagraph = (
    '\x07%(building)s "%(buildingName)s"…\x07…%(buildingVerb)s %(street)s.'
)
...
QuestDialogDict = {
    ...
    120: {
        QUEST: "Before we can set you free, you have one last task to do.\x07You will need to go see Mulzak.\x07He is our resident wizard, though these days he mainly focuses on producing crackers for Toontown.\x07Still delicious, though!\x07Anyway, why don’t you go and head over to him._where_"
    },
    121: {
    ...
    1039: {
        QUEST: "Our resident glue-maker, Sticky Lou, seems to have gotten himself in another sticky situation.\x07Please go over to his store and see if you can help him fix the issue.\x07Oh, and PLEASE tell him to be more careful around his glue!\x07We can’t keep sending Toons out there every other day to free him from the stickiness.where"
    },
    1040: {
    ...
    1042: {
        QUEST: "Alright!\x07The oil is ready for Lou.\x07Please tell him to be more careful next time!\x07Luckily for you, he’s my best customer!\x07So, I’m giving you my BEST oil!\x07See you ‘round.where"
    },
    1043: {
        QUEST: "Ah, you’re back!\x07What a joyous day!\x07Oh no, what’s this?\x07It isn’t going away!\x07Okay, I don’t know what will help me out now.\x07What?\x07You ALSO don’t know how?\x07Well then, I know the perfect person to tell.\x07The Master of Irrelevance!\x07You know, the famous Irrel!where"
    },
    1044: {
        QUEST: "Hi there, Toon!\x07What? Sticky Lou is stuck in ANOTHER pile of glue?\x07That’s nothing!\x07Just find some petroleum jelly!\x07It’s specialized for taking away stickiness, so it’d be perfect for your situation.\x07If I were you, I’d try asking Donut Doug.\x07He keeps all sorts of weird jellies around for his donuts!where"
    },
    1045: {
        QUEST: "What?\x07WHAT?\x07You're gonna have to speak up, laddie.\x07I don’t got no good hearing holes no more, ya’ see?\x07Smelly?\x07No?\x07Belly?\x07OH, jelly!\x07Sure!\x07I have plenty of types of jelly.\x07Strawberry, blueberry…\x07WHAT, PETROLEUM!?\x07Ye sure are one of the weird ones, but sure!\x07Tis not the first time being asked for that jelly, usually some mouse called… what was it?\x07Ah, Sticky Lou, me thinks.\x07He always comes ‘round asking for that.\x07I will need some time though! So, why don’t ye take down some of them robot thingers outside?"
    },
    1046: {
        QUEST: "Ye did it!\x07Thank ye’ so much, laddie!\x07Why don’t ye run this here jelly back ov’r to that Sticky Lou fella?where",
        COMPLETE: "Petroleum Jelly, are you kidding me, Toon?\x07You say it works?\x07Do you think I look like a loon?\x07Okay, okay, I will see how it does.\x07What’s this…\x07I’m free!\x07I feel like I could buzz!\x07You’ve earned your rewards, Toon! Even if the journey was a bit iffy…\x07Now, I’ve got to go!\x07I have to get another batch of glue going!",
    },
    # Task 4: Cheating The Cheethah
    1047: {
        QUEST: 'We need need you to go see Cheetah.\x07He has reported that he’s been having some issues with his "friends"?\x07Not sure what that means, but I know that you’ll be able to find out!\x07Good luck_where_'
    },
    1048: {
        QUEST: "Ay, ay, ay, what do we have here?\x07Oh, you're a Toon.\x07I've heard of you.\x07My fellow, uh... associate rivals believe I am a liar about business and scamming customers.\x07I need you to do some talking to my friends…\x07you see, my friends are Cogs.\x07Listen, I don’t engage in any Toony business, and I don’t fool around.\x07I need you to permanently erase my Cog friends.\x07Getting some Sellbots should do the trick.\x07Get rid of the competition and end this rivalry for good."
    },
    1049: {
        QUEST: "Thanks and all, but we've got ourselves a new problem, you see.\x07With all this Toony and Cog business in town, well, of course, my liar liar pants got stolen!\x07I need to set them on fire and get rid of them, like get rid of the evidence and all.\x07I don’t lie!\x07It’s my…\x07uh…\x07cousin’s pants?\x07Yes, my cousin’s! Just get it back in one piece.\x07I think someone dropped it in some lake."
    },
    1050: {
        QUEST: "Listen, I know you did a lot, but my aunt got her purse stolen by my friends.\x07I need you to be the town hero and all…\x07basically get my aunt her purse back."
    },
    1051: {
        QUEST: "Ok, so you did a pretty good job and all.\x07Now I need you to check in with my friends, the HQ Officers.\x07They owe me a sandwich.\x07Just get it from them.\x07I need it now, and I’m getting hungry!\x07I’ll pay you handsomely with all I got."
    },
    1052: {
        QUEST: "What's this…\x07A sandwich?\x07You got lied to, my friend.\x07You see, Cheetah likes to well…\x07cheat Toons out of things.\x07He has them do all kinds of stupid errands for him and then cheats them out of the reward they were supposed to get!\x07Always the same lies: a sandwich, liar liar pants, and some sort of purse.\x07Yeah, that purse wasn’t his, it belonged to another Toon.\x07I’m sorry to break the news to you, but Cheetah is nothing but a liar.\x07Here, take this note.\x07I’ve written that if he continues to act this way, we may have to take some action.",
        COMPLETE: "Whoa-whoa-whoa, back it up, buddy-o.\x07Yeah, so what if maybe the whole game was a cheat?\x07Maybe I rigged the game from the start.\x07Maybe…\x07I had a reward this whole time for you.\x07Oh wait, what?\x07A note?\x07HQ Officers, always pranksters.\x07This wasn’t a joke?\x07Oh, well… I suppose I should stop.\x07As for you, I guess you got in on some of the business I had in store.\x07I don’t normally do this, but I guess I’ll have to give you a reward.\x07You just have to do 50 buildings…\x07hah, just messing with you.\x07Now get outta here and keep this secret to yourself, mkay?",
    },
    # Task 5, Lean Mean Jellybean Machine
    # Yes its a Coach Z Evil Twin's Reference
    1053: {
        QUEST: "Next up, we have a task we think you’ll love, especially if you like Jellybeans.\x07Go see Silly Billy for your next task.where"
    },
    1054: {
        QUEST: "Howdy there, partner!\x07Now don’t get scared off if I say something you don’t understand.\x07That’s why they call me Silly Billy!\x07Now, I’ve heard you’re so poor that you have a tumbleweed as a pet!\x07I’m just kiddin’!\x07Now, bud, let me make a deal with ya’.\x07You go collect some stuff for me that I need, and I’ll see about settin’ you up with a new state-of-the-art Jellybean jar, eh?\x07Betcha like the idea of that!\x07To start off, I’ll need around 5 pieces of scrap metal.\x07That should do it.\x07I’d think that those Cogs are built of some, eh?\x07Go defeat some Cogs until ya’ get what I need."
    },
    1055: {
        QUEST: "Well, butter my buns and call me a biscuit!\x07Ya’ did it!\x07Now, go take these to Natta Cog at Not A Cog Place.\x07She is a pro at craftin’ all things from tiny doohickeys to… you guessed it, Jellybean jars!\x07She will fix ya up with what I need to make this for ya!where"
    },
    1056: {
    ...
    1057: {
        QUEST: "Thanks, buddy! Your jar is all finished, and I went ahead and sent it over to Silly Billy just for you.\x07You should go return to him now, see ya’ round.where",
    ...
    1069: {QUEST: "There, all done!\x07Go return these to Factor_where_."},
    1070: {
    ...
    # Reward: +2 Laff
    2001: {
        QUEST: "We have heard alot of good things about you _avName_ it is time for you to move on to Withering Woods.\x07Visit Instructor Gandling at The Withering School House._where_"
    },
    2002: {
        QUEST: "Well hello there you must be a new student!\x07Oh you are not a new student you say then what brings you here?\x07Ah yes now i know why you are here your the new toon\x07That flippy was raving about.\x07So You are here to choose your next gag track then?\x07Here in withering woods we dont give away free stuff so you will have to earn it.\x07The way you can earn it is very simple\x07a pesky Downsizer stole my instructor's pen.\x07Please recover the instructor's pen from that Downsizer and then I will allow you to choose your next gag track.\x07Hurry up i cant grade papers without my instructor's pen!"
    },  # Swap Downsizer for Sycophant
    2003: {
        QUEST: "Ah yes this pen will be very useful.\x07Or it would had been had that darn Downsizer not used up all the ink.\x07If you go fishing for some octopuses you can get more ink for me.\x07Remember octopuses can only be found in rainbow reef so you will have to go there to get some."
    },
    401: {
        GREETING: "",
    ...
    # Reward: +2 Laff
    2165: {
        QUEST: "Professor Oak is having a pet problem\x07So we need someone to fix it\x07Please go check up on the old man._where_"
    },
    2166: {
        QUEST: "Howdy toon are you here to help me with my problem?\x07Great i am a professor you see and and i also love to collect animals.\x07I had 3 very rare species of animals here in my lab but unfortunately\x07The cogs came in and stole all 3 of them can you help me find them?\x07Amazing the first was a Orange Lizard i saw a Two-Face take him.\x07Please Save him before they do something evil to him!"
    },  # Swap Two-Face for Temporizer
    2167: {
        QUEST: "Great job you found him but the other two are still out there somewhere\x07While you was gone i found this note it was dropped by a Number Cruncher\x07The Note Tells us the wearabouts of the next animal the Blue Turtle.\x07What are you waiting for _avName_ get a move on!"
    },
    2168: {
        QUEST: "Good Work we just got one more to go but unfortunately i have no clue\x07Where this one could be we could start with trying to find more notes\x07Go fight cogs till you find a note telling us the wearabouts of the final animal!"
    },
    2169: {
        QUEST: "Ok lets see here hmm interesting very interesting it seems the final animal\x07Was taken to a Big Wig. This is a dangerous task so tread lightly _avName_\x07I recommend finding other toons to attempt this.\x07Big Wigs can only be found in Buildings!",
        COMPLETE: "Thanks alot for recovering all my pets and as for your reward",
    },
    # Task 3: Food Fright
    # Reward: +2 Laff
    2170: {
        QUEST: "We got word that a disaster has happened over at Pizza Taco Burgers.\x07Go help him out im sure he will make it worth your while._where_"
    },
    2171: {
        QUEST: "Oh this is just terrible _avName_ thank goodness you have come to help me!\x07Have you heard of Dill Flye?\x07The famous Scientist himself was here at my shop.\x07I was so happy to serve him my famous taco burgers but there was one problem.\x07Cogs Poisoned my beef and Dill Flye got food poisoned!\x07And what's worse he blames me for it and he has threatened to sue me!\x07I tried to tell him it was the cogs and it wasn't my fault but he wouldn't believe me.\x07Maybe you can convince him that I am innocent!_where_"
    },
    2172: {
        QUEST: "Well hello there my toon friend you must have a good reason to be speaking to me?\x07Yes indeed i did threaten to sue pizza taco why does it matter to you?\x07So he sent you to me to try and get me to change my mind?\x07I will tell you what if you can get proof that the cogs did it i will change my mind.\x07Solver Sullivan at Axe-idents Happen will be a good start._where_"
    },
    2173: {
        QUEST: "Hello there _avName_ how may I assist you today?\x07So you wish to find evidence that Pizza Taco is innocent?\x07Its a good thing you came so soon because I happened to over hear some cogs planning to poison something.\x07Im sure if you fight some of the cogs you will find a journal detailing plans to commit this act."
    },
    2174: {
        QUEST: "You did it you found the evidence hurry and take it to Dill Flye!_where_"
    },
    2175: {
        QUEST: "Great you have done me and pizza taco a great favor!\x07Take this note to him saying that i apologize for the false accusations._where_"
    },
    2176: {
        QUEST: "Thanks _avName_ for all the help but we have one more problem\x07The Cogs found out that there plan was ruined and they sent a Legal Eagle after me\x07I was able to get away but he stole my special golden spatula please recover my Golden Spatula.\x07Also legal eagles can only be found in buildings good luck",
        COMPLETE: "Thank you so much _avName_\x07I cannot explain how happy you have made me",
    },
    # Task 4: Got any grapes?
    # Reward: +2 Laff
    2177: {
        QUEST: "Doug The Duck is going through a grape crisis\x07Can you help prevent a Graptastorphy._where_"
    },
    2178: {
        QUEST: "The Cogs stole all my Grape juice!\x07I am thirsty and all i have left here in my shop is lemonade and im totally not making a duck song reference, but i hate lemonade.\x07Please recover a case of grape juice from the cogs!"
    },
    2179: {
        QUEST: "What is this? I said recover Grapes not Grape Juice\x07Get back out there and find my grapes!"
    },
    2180: {
        QUEST: "No you REALLY must of misheard me\x07Grapes stink\x07I really just need is for you to take down a 3 Story Cog Building.",
    ...
    2181: {
        QUEST: "Mr. Dunky was having a yard sale when the cogs stole all his products\x07Go see if you can help him out if you wanna get a huge reward._where_"
    },
    2182: {
        QUEST: "Hello there _avName_, what have you come to buy?\x07Well unfortunately I have nothing left thanks to the cogs\x07I am selling my business and was having a huge sale\x07because everything has to go when a bunch of Cogs came in and stole all my items.\x07If you can help return my items i can give you an old gag pouch.\x07There was 20 of them\x07You can find them on any Cog here in Withering Woods."
    },
    2183: {
        QUEST: "Great job but we have one big problem.\x07While you were gone a money bags came in and took the gag pouch.\x07If You can find that money bags ill let you keep the gag pouch free of charge.",
        COMPLETE: "I Think you more than earned the right to keep this gag pouch!",
    },
    # Task 6: The Training Of A Warrior
    # Reward: +4 Laff
    2184: {
        QUEST: "Master Shifo at Fist and Palm Trees:Dojo is looking for the next great Kung Fu Master\x07Do you think you got what it takes?._where_"
    },
    2185: {
        QUEST: "Hello there toon it is a great honor to meet you i have heard great things about you\x07But as great as you are i don't think you got what it takes to be a Kung Fu Master\x07If you want to prove yourself worthy of being a black belt as well as receiving a 4 point laff boost then let me show you the ropes grasshopper.\x07First to Rise the ranks you must defeat Sellbots.\x075 of them to be exact\x07Good luck i am to be expecting your return"
    },
    2186: {
        QUEST: "Good job my student you have proven yourself worthy to wear this White Belt \x07You have made me proud but you are not done yet i am getting  old and very weak and some day i will need to pass this dojo down to a new master i would be honored for it to be you once your journeys are over but first i require that you atleast reach the black belt ranks\x07The next part of your Journey to becoming a Black Belt is Cashbots\x07 Please defeat 10 of them then return to me."
    },
    2187: {
    ...
    2188: {
        QUEST: "You are ready for your final test to earn your black belt it is very simple i require that you take down one of the toughest buildings here in Withering Woods take down a 4 story\x07And then return to me for your final reward",
    ...
    # Reward: +3 Laff
    2189: {
        QUEST: "Howdy _avName_\x07Green the Ogre over at xer shop is having a problem with fairy tale creatures\x07Xe needs your help to get rid of them._where_"
    },
    2190: {
    ...
    2191: {
        QUEST: "Good but we got one problem I cant read this its in some type of ancient language.\x07You will have to find a way to translate this maybe the library here in Withering woods will be a good start Librarian Lucas im sure will have what we need to translate this head over to Shhh! Library.\x07Thats where Lucas sets up shop good luck._where_"
    },
    2192: {
        QUEST: "Welcome to my library these books come in all sizes all lengths and all times. New,old,long and short we got them all so what brings you here? Ah so you need a book to learn how to translate this journal? Lets see here hmm interesting this journal is in toonivari language an ancient toon civilization they used all types of symbols for there language when it was written i have what you need or i would of had it had a Downsizer not come in and take it\x07Ill tell you what if you find that Downsizer and recover that book ill let you keep it for free hows that sound?\x07Good now hurry up and get that Downsizer before its to late"
    },  # Downsizer -> Control Freak
    2193: {
        QUEST: "Good job unfortunately i cant translate this for you right now cause im very busy\x07Im sure you or whoever needed this will be able to do it just fine see ya around!"
    },
    2194: {
        QUEST: "Thanks for all the help but i will need time to translate this im kinda struggling here\x07In the mean time go take down 1 3+ Story Cog Buildings that should give me enough time to figure this out."
    },
    2195: {
        QUEST: "Good Job Ive cracked the code it looks like the culprit of this operation is one of the most strongest cogs, Mr. Hollywood himself.\x07You must gather a group of toons and go find one.",
    ...
    2197: {
        QUEST: "Halt You Shall not pass!\x07Oh your not a cog so your here to help me?\x07Great\x07So There was this ring a very powerful ring if fallen into the wrong hands could be\x07Catastrophic for everyone and alas thats exactly what happened a group of corporate raiders\x07Raided my shop and i fear the worse they are taking the ring back to there boss you must stop them\x07Before it is to late _avName_!\x07Corporate Raiders can only be found in buildings"
    },
    2198: {
        QUEST: "No this isnt good this isnt the right ring we will have to look again try to find another corporate raider this is just a normal gold ring nothing special about it "
    },
    2199: {
    ...
    2200: {
        QUEST: "Ah so your are a mage i have plenty of spells for sale for any able body with the skill enough to cast them.\x07Oh your not a mage well then what brings you here my friend?\x07Ah Dangolf my good pal has sent you here to fix this Ring this was a very powerful artifact i could fix it\x07But The Cogs Stole my Magical Wand if you recover it from them then we can continue "
    },
    2201: {
        QUEST: "You found it great i can fix it but it will take awhile\x07In the mean while clear out a 4 story+ Cog Building while your at it"
    },
    2202: {
        QUEST: "Great its all fixed up here take it dangolf and tell him i said fair greetings!",
    ...
    2210: {
        QUEST: "Hey there again my friend! So you like withering woods right you think its liveable?\x07Well most people dont think so withering woods is rated the worst place to live in toon island\x07It is very sad it hurts my heart ive lived here since i was a little boy way before most of the outsider toons came here i want to restore this place to its former glory withering woods wasnt always so withering \x07And while we cant fix the withering part we can for sure make it a place to wanna live i was planning on giving away four free tickets for a vacation here in withering woods at an amazing five star resort\x07But the cogs took them you will need to recover each one then bring them to the toons that i planned on\x07Giving them to the first ticket was taken by a Two-Face"
    },
    2211: {
        QUEST: "Good Job!\x07Now your destination is Pop That Corn! Popcorn Making\x07Take this ticket to King Popcorn._where_"
    },
    2212: {
        QUEST: "Hows it going would you like to try some of my amazing popcorn?\x07Oh you got a gift for me what is it?\x07Wonderful a free vacation to withering woods id love to tell Slippery Sloppy\x07I Will Be On My Way as soon as possible._where_"
    },
    2213: {
        QUEST: "Alright Good job the next Cog you will need to take out is an Head Hunter."
    },
    2214: {
        QUEST: "Two Down two to go\x07Alright take this to Reg at the Sandy Spitoon in Olive Oasis then return once you do._where_"
    },
    2215: {
        QUEST: "Welcome to the Sandy Spitoon how tough are you?\x07Your so tough that you brought me a free vacation ticket to Withering Woods?\x07Wow that is impressive anyways tell Slippery Sloppy I Accept His Offer._where_"
    },
    2216: {
        QUEST: "Great ok so now  we need a ticket that was stolen by an Mingler\x07Minglers can only be found in buildings good luck!"
    },
    2217: {
        QUEST: "Only One More to go after this one keep it up!\x07Take this to Rod Rooster at Rock-A-Doodle-Doo in Minty Mines._where_"
    },
    2218: {
        QUEST: "Welcome to the best shop to hear some Rock N Roll Baby! Whats this you have something for me?\x07A Vacation Trip to Withering Woods?\x07Why would i want to go there that place is almost as bad as Olive Oasis.\x07You say it will be worth my while?\x07Fine i guess ill believe you tell Slippery Sloppy that i will come stay at this resort for a vacation._where_"
    },
    2219: {
        QUEST: "Great ok for the last ticket it seems i have no knowledge of what cog took it\x07So just fight cogs till you find it good luck!"
    },
    2220: {
        QUEST: "Great you have found all the tickets now hurry and take this one to Howard Horse at The Family Friendly Stern and then you can receive your reward._where_"
    },
    2221: {
        QUEST: "Hows it going bro\x07Welcome to the Family Friendly Stern where the whole family can come to have fun what brings you here?\x07Great thanks for this ticket my friend i will be packing my things as soon as you leave\x07Tell Slippery Sloppy i said whats up!_where_",
    ...
    2222: {QUEST: "Return to Instructor Gandling\x07He needs you urgently._where_"},
    2223: {
    ...
    # Reward: Gag Training
    3001: {
        QUEST: "How's it going, _avName_?\x07We heard great things about your efforts in Toon Island Central and Withering Woods.\x07Rainbow Rise could really use a toon like you.\x07Speak to Pegleg Peg at Peg's Pegged Peg Legs._where_"
    },
    3002: {
    ...
    # Reward: +3 Laff Boost
    3161: {
        QUEST: "Report to Howard Horse at The Family Friendly Stern.\x07He is having problems with cogs hacking into his television channel\x07spreading non-toony propaganda._where_"
    },
    3162: {
        QUEST: "Hello, _avName_!\x07Good thing you made it.\x07How am I supposed to make a profit off my television channel with the cogs hacking into it\x07spreading non-toony propaganda?\x07If you can help me out, I'll reward you well.\x07I bet if you take down three 3-story Bossbot buildings, it will prevent the cogs from hacking into my channel."
    },
    3163: {
        QUEST: "That didn't seem to work.\x07Maybe if we try a 4-story Bossbot building, it will stop this nonsense."
    },
    3164: {
        QUEST: "Hmm, that didn't work either. While you were gone, I've come up with the solution.\x07We need to take out the head honcho of this operation.\x07You need to defeat a Big Cheese to stop this madness.\x07That should work.",  # Swap to Control Freak when Cog Update is done.
    ...
    3165: {
        QUEST: "Jonathan Sea-No has sprayed himself with invisibility spray and is stuck invisible.\x07He needs your help to become visible again.\x07I'm sure he will reward you if you help him._where_"
    },
    3166: {
        QUEST: "It's a disaster, _avName_!\x07I sprayed myself with this invisibility spray because I wanted to scare my friend as a prank, but now I'm stuck like this.\x07It seems the cogs switched my temporary spray out with a permanent one, and now I'm stuck.\x07There has to be a way to reverse this.\x07I got an idea, go see my friend Baron Corbear at Rain-Below 5$ Or Less.\x07I'm sure he has a product that can help reverse this._where_"
    },
    3167: {
        QUEST: "Welcome _avName!\x07So Jonathan sent you.\x07Very well, you need a product that will help him reverse his invisibility.\x07Well, you came to the right place.\x07I have some Anti-Invisibility Shampoo, but they are currently out of stock.\x07They won't be in stock for another couple of days.\x07If you go defeat some cogs, that should kill some time."
    },
    3168: {
        QUEST: "Good job on defeating those cogs.\x07The shampoo came back in stock, but some Big Wigs came by and stole all the shampoo.\x07I guess that's how they keep their hair so perfect\x07but that's beside the point.\x07Before I give you any\x07I need you to recover all of the shampoo that they stole."
    },
    3169: {
        QUEST: "Great, you did it!\x07I knew I could trust you. Here, keep some Anti-Invisibility Shampoo.\x07It should work.\x07Take this to, Jonathan Sea-No._where_"
    },
    3170: {
        QUEST: "Thanks! It took you long enough, though.\x07Well, while I'm taking a shower, why don't you go recover my real invisibility spray so no one has to suffer this fate again?\x07You can find them on any cogs in Rainbow Rise.",
        COMPLETE: "It worked! Wow, you did me a good deed here today, _avName_! You deserve a reward.",
    ...
    3176: {
        QUEST: "Okay, that will be good enough.\x07Go talk to Bob Square\x07Tell him I will not be pursuing any legal actions against himand his crew._where_",
...
AvatarDetailPanelOnline = (
    "District: %(district)s\nLocation: %(location)s\nToonID: %(toonid)s"
)
AvatarDetailPanelOnlinePlayer = (
    "District: %(district)s\nLocation: %(location)s\nPlayer: %(player)s"
)
...
ReportPanelRemovedFriend = (
    "We have automatically removed %s from your Toon Friends List."
)
...
IgnorePanelAddFriendAvatar = (
    "%s is your friend, you cannot ignore them while you are friends."
)
IgnorePanelAddFriendPlayer = (
    "%s (%s)is your friend, you cannot ignore them while you are friends."
)
PetPanelFeed = "Feed"
PetPanelCall = "Call"
PetPanelGoTo = "Go To"
...
RewardPanelUberGag = (
    "%(avName)s earned the %(gagName)s gag with %(exp)s experience points!"
)
RewardPanelEndTrack = (
    "Yay! %(avName)s has reached the end of the %(gagName)s Gag Track!"
)
...
KnockKnockContestJokes = {
    2100: ["Wally", "Wally's not looking, hit him with a pie!"],
    2200: {
        28: ["Biscuit", "Biscuit out of here the Cogs are coming!"],
    ...
    3300: {
        10: ["Aladdin", "Aladdin HQ wants a word with you."],
...
KnockKnockJokes = [
    ...
    ],  # TODO: RETRO MODE "Wooden shoe like to know."
...
MickeyChatter = (
    ...
    [
        "I'm going to " + CCharChatterMelodyLand + " to see " + Minnie + "!",
...
ValentinesMickeyChatter = (
    ...
    ["I loved having you visit!", "Tell Minnie I'll pick her up soon!"],
)
...
WinterMinnieCChatter = (
    ...
    ["Have a fun Winter Holiday!", "Happy Trails!", "Mickey is taking me caroling!"],
)
...
ValentinesMinnieChatter = (
    ["Hello, I'm Minnie!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %"],
    [
...
ValentinesDaisyChatter = (
    ["Hi, I'm Daisy!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %"],
    [
    ...
    ["Tell Donald I'll be waiting for him!", "Have a nice ValenToon's Day!"],
)
WinterDaisyCChatter = (
    [
...
ValentinesChipChatter = (
    ["I'm Chip!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
    [
...
WinterChipChatter = (
    ["Happy Winter Holiday!", "Dressed as chipmunks!", "Happy Winter Holiday, %!"],
    [
    ...
    ["Go nuts this Winter Holiday!", "Have a joyful winter Holiday!"],
)
HalloweenChipChatter = (
    ["Play some MiniGhoul… I mean Golf!", "Happy Halloween!", "Happy Halloween, %!"],
    [
...
ValentinesDaleChatter = (
    ["I'm Dale!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
    [
...
WinterDaleChatter = (
    ...
    ["And bring some back for us!", "Have a joyful Winter Holiday!"],
)
HalloweenDaleChatter = (
    ["Happy Halloween, %!", "Play some MiniGhoul… I mean Golf!", "Happy Halloween!"],
    [
        "We're nuts about Halloween!",
...
ValentinesGoofyChatter = (
    ...
    ["Drive safe, now!", "Show some love out there!"],
)
...
DonaldChatter = (
    ["Welcome to Dreamland.", "Hi, my name is %s. What's yours?" % Donald],
    [
...
WinterDreamlandCChatter = (
    ...
    ["To all, a good night!", "Sweet dreams!", "When I wake up I am going caroling!"],
)
...
HalloweenDreamlandChatter = (
    ["Happy Halloween!", "Happy Halloween, %!", "Hi, I'm FrankenDonald!"],
    [
...
ValentinesDreamlandChatter = (
    ...
    ["Nite-nite!", "Wake me when it's ValenToon's Day!"],
)
...
ValentinesDonaldChatter = (
    ["Ahoy, I'm Donald!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
    [
...
AFMickeyChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
    [
    ...
    ["Have a wacky April Toons' Week!", "Tell Mickey I said hi!"],
)
AFMinnieChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
    [
    ...
    ["Have a wacky April Toons' Week!", "I have to go chase cars now! Bye!"],
)
AFDaisyChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
    [
...
AFDonaldChatter = (
    ...
    ["Have a wacky April Toons' Week!", "I need to work on my karts! Bye!"],
)
AFDonaldDockChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
    [
    ...
    ["Have a wacky April Toons' Week!", "Play a joke on the Cogs for me!"],
)
AFPlutoChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
    [
...
GPGoofySpeedwayChatter = (
    ...
    [
        ...
        "Hey, have you seen "
        + Donald
        + "? He said he was gonna come watch the Grand Prix!",
...
FriendInviterClickToon = (
    "Click on the Toon you would like to make friends with.\n\n(You have %s friends)"
)
...
FriendInviterEndFriendshipToon = (
    "Are you sure you want to stop being Toon friends with %s?"
)
FriendInviterEndFriendshipPlayer = (
    "Are you sure you want to stop being player friends with %s?"
)
...
LauncherDownloadFilePercent = (
    "Downloading update for " + LauncherProgress + ": %(percent)s%%"
)
LauncherDecompressingFile = "Decompressing update for " + LauncherProgress + "…"
LauncherDecompressingPercent = (
    "Decompressing update for " + LauncherProgress + ": %(percent)s%%"
)
LauncherExtractingFile = "Extracting update for " + LauncherProgress + "…"
LauncherExtractingPercent = (
    "Extracting update for " + LauncherProgress + ": %(percent)s%%"
)
...
AvatarChoiceDeletePasswordText = (
    "Careful! This will delete %s forever. To delete this Toon, enter your password."
)
...
AvatarChoiceDeleteWrongPassword = (
...
PartyHasStartedNotAcceptedInvite = (
    "%s party has started! You can still go to it by teleporting to the host."
)
...
EventsPageCancelPartyResultOk = (
    "Your party was cancelled and you got %d Jellybeans back!"
)
EventsPageCancelPartyResultError = "Sorry, your party was not cancelled."
EventsPageCancelPartyAlreadyRefunded = (
    "Your party was never started. Check your mailbox for your refund!"
)
EventsPageTooLateToStart = (
...
PartyPlannerEditorInstructionsClickedElementActivity = (
    "Click Buy or Drag the Activity Icon onto the Party Grounds Map"
)
PartyPlannerEditorInstructionsClickedElementDecoration = (
    "Click Buy or Drag the Decoration onto the Party Grounds Map"
)
PartyPlannerEditorInstructionsDraggingActivity = (
    "Drag the Activity onto the Party Grounds Map."
)
PartyPlannerEditorInstructionsDraggingDecoration = (
    "Drag the Activity onto the Party Grounds Map."
)
PartyPlannerEditorInstructionsPartyGrounds = (
    "Click and Drag items to move them around the Party Grounds Map"
)
PartyPlannerEditorInstructionsTrash = (
...
PartyPlannerConfirmationAllOkText = (
...
PartyPlannerInvitationWhenSentence = (
    "It will be on %s,\nat %s Toontown Time.\nHope you can make it!"
)
PartyPlannerInvitationWhenSentenceNoFriends = (
    "It will be on %s,\nat %s Toontown Time.\nToontastic!"
)
...
PartyDecorationNameDict = {
    ...
    2: {"editor": "Party Bow", "description": "Wrap up the fun!"},
    3: {"editor": "Cake", "description": "Delicious."},
    4: {"editor": "Party Castle", "description": "A Toon's home is his castle."},
    5: {"editor": "Gift Pile", "description": "Gifts for every Toon!"},
    6: {"editor": "Streamer Horn", "description": "This horn is a hoot! Streamers!"},
    7: {"editor": "Party Gate", "description": "Multi-colored and crazy!"},
    8: {"editor": "Noise Makers", "description": "Tweeeeet!"},
    9: {"editor": "Pinwheel", "description": "Colorful twirling for everyone!"},
    10: {"editor": "Gag Globe", "description": "Gag and star globe designed by Olivea"},
    11: {
        "editor": "Bean Banner",
    ...
    13: {"editor": "Cupid's Heart", "description": "Ready…Aim…\nValenToons!"},
    14: {
        "editor": "Candy Hearts\n Banner",
    ...
    17: {"editor": "Victory Banner", "description": "Not just a normal banner!"},
    18: {"editor": "Confetti Cannons", "description": "BOOM! Confetti! Fun!"},
    19: {"editor": "Cog & Doodle", "description": "Ouch! That's gotta hurt."},
    20: {
        "editor": "Cog Flappy Man",
        "description": "A Cog full of hot air, what a shock!",
    },
    21: {"editor": "Cog Ice Cream", "description": "A Cog looking his best."},
    22: {"editor": "CogCicle", "description": "A Cog looking his holiday best."},
    23: {
        "editor": "Holiday Bandstand",
        "description": "Everyone loves a Holiday Party!",
    },
    24: {"editor": "Chilly Cog", "description": "Ouch! That's gotta hurt."},
    25: {"editor": "Snowman", "description": "So cool, he's hot!"},
    26: {"editor": "SnowDoodle", "description": "His only trick is being cold!"},
    27: {
...
PartyActivityWaitingForOtherPlayers = (
...
PartyCatchActivityInstructions = (
    "Catch as many pieces of fruit as you can. Try not to 'catch' any %(badThing)s!"
)
...
WinterPartyCatchActivityInstructions = (
    "Catch as many presents as you can. Try not to 'catch' any %(badThing)s!"
)
...
PartyTrampolineBonusBeanResults = (
    "You collected %d jelly beans, plus %d more for getting the Big Bean."
)
...
ShardPageHelpWelcomeValley = (
    '  You are currently in the "Welcome Valley" District, within "%s".'
)
...
UnknownFish = "???"
FishingRod = "%s Rod"
FishingRodNameDict = {0: "Twig", 1: "Bamboo", 2: "Hardwood", 3: "Steel", 4: "Gold"}
FishTrophyNameDict = {
    0: "Guppy",
    1: "Minnow",
    2: "Fish",
...
BattleGlobalAvTrackAccStrings = ("70%", "100%", "50%", "95%", "75%", "95%", "50%")
...
TutorialFriendsButton = (
    "Now click the 'Friends' button under %s's picture in the right hand corner."
    % Flippy
)
...
TutorialFriendsPanelMickeyChat = (
    "%s has agreed to be your friend. Click 'Ok' to finish up." % Flippy
)
...
TutorialAllFriendsButton = (
    "You can view all your friends by clicking the friends button. Try it out…"
)
TutorialEmptyFriendsList = (
    "Right now your list is empty because %s isn't a real player." % Flippy
)
TutorialCloseFriendsList = "Click the 'Close'\nbutton to make the\nlist go away"
TutorialShtickerButton = (
...
PlaygroundDeathAckMessage = (
    TheCogs
    + " took all your gags!\n\nYou are sad. You may not leave the playground until you are happy."
)
ForcedLeaveFactoryAckMsg = (
    "The "
    + Foreman
    + " was defeated before you could reach him. You did not recover any Cog parts."
)
...
TwoDGameInstructions = (
    "Escape from the "
    + Cog
    + " den as soon as you can. Use arrow keys to run/jump and Ctrl to squirt a "
    + Cog
    + ". Collect "
    + Cog
    + " treasures to gain even more points."
)
...
PatternGameInstructions = (
    Minnie
    + " will show you a dance sequence. "
    + "Try to repeat "
    + Minnie
    + "'s dance just the way you see it using the arrow keys!"
)
...
MazeGameInstructions = (
    "Collect the treasures. Try to get them all, but look out for the " + Cogs + "!"
)
CatchGameTitle = "Catching Game"
CatchGameInstructions = (
    "Catch as many %(fruit)s as you can. Watch out for the "
    + Cogs
    + ", and try not to 'catch' any %(badThing)s!"
)
...
STOREOWNER_CONFIRM_LOSS = (
    "Your closet is full. You will lose the clothes you were wearing."
)
STOREOWNER_OK = lOK
STOREOWNER_CANCEL = lCancel
STOREOWNER_TROPHY = (
    "Wow! You collected %s of %s fish. That deserves a trophy and a Laff boost!"
)
...
QuestScriptTutorialMickey_3 = (
    "Tutorial Tom will tell you all about the Cogs.\x07Gotta go!"
)
...
QuestScript100_10 = (
    "The Sellbots who make money chugging out Cog parts from their factories…"
)
...
QuestScript100_17 = (
    "It keeps us healthy and fit for cog fights, and makes it harder for us to go sad"
)
...
QuestScript100_20 = (
    "These are the bane of the Cogs’ existence and the Gags repel them with ease!"
)
QuestScript100_21 = (
    "Now, you must be wondering what happened to the mainland, Toontown?"
)
...
QuestScriptTutorialBlocker_5 = (
    "Very good!\x07Where you are going, there are many Toons to talk to."
)
...
QuestScriptGagShop_6 = (
    "When you're done buying your gags, click this button to return to the playground."
)
...
QuestScript140_1 = (
    "Good job finding the trolley!\x07By the way, I have this friend, Librarian Liz, who is quite a book worm.\x07I picked this book up for him last time I was over in "
    + lDonaldsDock
    + ".\x07Could you take it over to him, he is usually in the New Toontown Continental Library."
)
...
QuestScript150_1 = (
    "Great work!\x07Did you know that Toontown is WAY more fun when you have friends?"
)
...
CagedToonPrepareBattleTwo = (
    "Look out, he's trying to get away!\x07Help me, everyone--get up here and stop him!"
)
...
ResistanceToonToonupAllInstructions = (
...
ResistanceToonMoneyAllInstructions = (
    "all the Toons near you will fill their Jellybean jars"
)
ResistanceToonRestockInstructions = (
    'all the Toons near you will restock their "%s" gags'
)
ResistanceToonRestockAllInstructions = (
...
MintElevatorRejectMessage = (
    "You cannot enter the Mints until you have completed your %s Cog Suit."
)
BossElevatorRejectMessage = (
...
for accessoryId in list(CatalogAccessoryItemGlobals.AccessoryTypes.keys()):
    ...
    if accessoryInfo[3]:
        AwardManagerAccessoryNames[accessoryId] = (
            AccessoryNamePrefix[accessoryInfo[0]]
            + accessoryStyleDescription[accessoryInfo[1]]
        )
...
SpecialEventMailboxStrings = {
    1: "A special item from the Toon Council just for you!",
...
CatalogNotifyNewCatalogNewDelivery = (
    "A new delivery has arrived at your mailbox! Also, your cattlelog #%s has arrived!"
)
CatalogNotifyNewDelivery = "A new delivery has arrived at your mailbox!"
CatalogNotifyNewCatalogOldDelivery = (
    "Your cattlelog #%s has arrived, and there are still items waiting in your mailbox!"
)
CatalogNotifyOldDelivery = (
...
CatalogPurchaseGiftItemOnOrder = (
    "Excellent! Your gift to %s will be delivered to their mailbox."
)
...
CatalogPurchaseGiftNotAGift = (
    "This item could not be sent to %s because it would be an unfair advantage."
)
CatalogPurchaseGiftWillNotFit = (
    "This item could not be sent to %s because it doesn't fit them."
)
CatalogPurchaseGiftLimitReached = (
    "This item could not be sent to %s because they've already have it."
)
CatalogPurchaseGiftNotEnoughMoney = (
    "This item could not be sent to %s because you can't afford it."
)
...
CatalogVerifyPurchaseBeanGold = (
    "Purchase %(item)s for %(price)s Jellybeans and %(gold)s gold emblems?"
)
CatalogVerifyPurchaseBeanSilver = (
    "Purchase %(item)s for %(price)s Jellybeans and %(silver)s silver emblems?"
)
CatalogVerifyPurchaseSilverGold = (
    "Purchase %(item)s for %(silver)s silver emblems and %(gold)s gold emblems?"
)
...
CatalogVerifyGift = (
    "Purchase %(item)s for %(price)s Jellybeans as a gift for %(friend)s?"
)
...
EstateTeleportFailedNotFriends = (
    "Sorry, %s is in a Toon's estate that you are not friends with."
)
...
TipDict = {
    ...
    TIP_MINIGAME: (
        ...
        "Trolley Game difficulty varies by neighborhood; "
        + lToonIslandCentral
        + " has the easiest and "
        + lDonaldsDreamland
        + " has the hardest.",
...
KartDNA_KartNames = {0: "Cruiser", 1: "Roadster", 2: "Toon Utility Vehicle"}
KartDNA_AccNames = {
    1000: "Air Cleaner",
    1001: "Four Barrel",
    1002: "Flying Eagle",
...
KartTrophyDescriptions = [
    str(RaceGlobals.QualifiedRaces[0])
    + " "
    + RaceHoodSpeedway
    + " "
    + Race
    + " "
    + RaceQualified,
    str(RaceGlobals.QualifiedRaces[1])
    + " "
    + RaceHoodSpeedway
    + " "
    + Races
    + " "
    + RaceQualified,
    str(RaceGlobals.QualifiedRaces[2])
    + " "
    + RaceHoodSpeedway
    + " "
    + Races
    ...
    + " "
    + RaceQualified,
    str(RaceGlobals.TotalQualifiedRaces)
    + " "
    + Total
    + " "
    + Races
    ...
    str(RaceGlobals.WonCircuitRaces[0])
    + " "
    + RaceTypeCircuit
    + " "
    + Race
    + " "
    + RaceQualified,
    str(RaceGlobals.WonCircuitRaces[1])
    + " "
    + RaceTypeCircuit
    + " "
    + Races
    + " "
    + RaceQualified,
    str(RaceGlobals.WonCircuitRaces[2])
    + " "
    + RaceTypeCircuit
    + " "
    + Races
    ...
    + " "
    + RaceWon,
    str(RaceGlobals.SweptCircuitRaces[0])
    + " "
    + RaceTypeCircuit
    + " "
    + Race
    + " "
    + RaceSwept,
    str(RaceGlobals.SweptCircuitRaces[1])
    + " "
    + RaceTypeCircuit
    + " "
    + Races
    + " "
    + RaceSwept,
    str(RaceGlobals.SweptCircuitRaces[2])
    + " "
    + RaceTypeCircuit
    + " "
    + Races
    ...
    str(RaceGlobals.TrophiesPerCup * 2)
    + " Kart Racing trophies won! Laff point boost!",
    str(RaceGlobals.TrophiesPerCup * 3)
    + " Kart Racing trophies won! Laff point boost!",
]
...
LawbotBossTaunts = [
    "%s, I find you in contempt of court!",
    "Objection sustained!",
...
SummonDlgInvasionBusy = (
    "A %s cannot be found now. Try again when the Cog invasion is over."
)
...
PolarPlaceEffect3 = (
    NPCToonNames[3306] + ": Your new look will only work in " + lTheBrrrgh + "."
)
...
FlowerFunnyNames = {
    ...
    53: ("Laff-o-dil", "Daffy Dill", "Giraff-o-dil", "Time and a half-o-dil"),
    54: ("Dandy Pansy", "Chim Pansy", "Potsen Pansy", "Marzi Pansy", "Smarty Pansy"),
...
ShovelNameDict = {0: "Tin", 1: "Bronze", 2: "Silver", 3: "Gold"}
WateringCanNameDict = {0: "Small", 1: "Medium", 2: "Large", 3: "Huge"}
...
TravelGameReasonVotesPlural = (
    "The trolley is moving %(dir)s, winning by %(numVotes)d votes."
)
TravelGameReasonVotesSingular = (
    "The trolley is moving %(dir)s, winning by %(numVotes)d vote."
)
...
GolfTrophyDescriptions = [
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CoursesCompleted][0])
    + " "
    + CoursesCompleted,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CoursesCompleted][1])
    + " "
    + CoursesCompleted,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CoursesCompleted][2])
    + " "
    + CoursesCompleted,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CoursesUnderPar][0])
    + " "
    + CoursesUnderPar,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CoursesUnderPar][1])
    + " "
    + CoursesUnderPar,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CoursesUnderPar][2])
    + " "
    + CoursesUnderPar,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.HoleInOneShots][0])
    + " "
    + HoleInOneShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.HoleInOneShots][1])
    + " "
    + HoleInOneShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.HoleInOneShots][2])
    + " "
    + HoleInOneShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.EagleOrBetterShots][0])
    + " "
    + EagleOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.EagleOrBetterShots][1])
    + " "
    + EagleOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.EagleOrBetterShots][2])
    + " "
    + EagleOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.BirdieOrBetterShots][0])
    + " "
    + BirdieOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.BirdieOrBetterShots][1])
    + " "
    + BirdieOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.BirdieOrBetterShots][2])
    + " "
    + BirdieOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.ParOrBetterShots][0])
    + " "
    + ParOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.ParOrBetterShots][1])
    + " "
    + ParOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.ParOrBetterShots][2])
    + " "
    + ParOrBetterShots,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.MultiPlayerCoursesCompleted][0])
    + " "
    + MultiPlayerCoursesCompleted,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.MultiPlayerCoursesCompleted][1])
    + " "
    + MultiPlayerCoursesCompleted,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.MultiPlayerCoursesCompleted][2])
    + " "
    + MultiPlayerCoursesCompleted,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseZeroWins][0])
    + " "
    + CourseZeroWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseZeroWins][1])
    + " "
    + CourseZeroWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseZeroWins][2])
    + " "
    + CourseZeroWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseOneWins][0])
    + " "
    + CourseOneWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseOneWins][1])
    + " "
    + CourseOneWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseOneWins][2])
    + " "
    + CourseOneWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseTwoWins][0])
    + " "
    + CourseTwoWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseTwoWins][1])
    + " "
    + CourseTwoWins,
    str(GolfGlobals.TrophyRequirements[GolfGlobals.CourseTwoWins][2])
    + " "
    + CourseTwoWins,
]
GolfCupDescriptions = [
    str(GolfGlobals.TrophiesPerCup) + " Trophies won",
    str(GolfGlobals.TrophiesPerCup * 2) + " Trophies won",
    str(GolfGlobals.TrophiesPerCup * 3) + " Trophies won",
]
...
BoardcodeMinLaffLeader = (
    "Your group cannot board because you have less than %s laff points."
)
BoardcodeMinLaffNonLeaderSingular = (
    "Your group cannot board because %s has less than %s laff points."
)
BoardcodeMinLaffNonLeaderPlural = (
    "Your group cannot board because %s have less than %s laff points."
)
BoardcodePromotionLeader = (
    "Your group cannot board because you do not have enough promotion merits."
)
BoardcodePromotionNonLeaderSingular = (
    "Your group cannot board because %s does not have enough promotion merits."
)
BoardcodePromotionNonLeaderPlural = (
    "Your group cannot board because %s do not have enough promotion merits."
)
...
BoardingInviteMinLaffInviter = (
    "You need %s Laff Points before being a member of this Boarding Group."
)
BoardingInviteMinLaffInvitee = (
    "%s needs %s Laff Points before being a member of this Boarding Group."
)
BoardingInvitePromotionInviter = (
    "You need to earn a promotion before being a member of this Boarding Group."
)
BoardingInvitePromotionInvitee = (
    "%s needs to earn a promotion before being a member of this Boarding Group."
)
BoardingInviteNotPaidInvitee = (
    "%s needs to be a paid Member to be a part of your Boarding Group."
)
BoardingInviteeInDiffGroup = "%s is already in a different Boarding Group."
BoardingInviteeInKickOutList = (
    "%s had been removed by your leader. Only the leader can re-invite removed members."
)
...
HolidayNamesInCalendar = {
    ...
    105: (
        "Toons go GREEN!",
        "Toons make a green scene at Green Bean Jeans on Raven Road in Withering Woods!",
    ),
}
...
CogdoBarrelIntroMovieDialogue = (
    "Good work! You've halted the %s and are now able to collect some of the stolen Laff Barrels, but make sure to hurry before the Cogs come!"
    % CogdoStomperName
)
...
CogdoFlyingIntroMovieDialogue = (
    (
        ...
        "A flock of Toons! We're crushing barrels of your Laff in our %s, and there's nothing you can do about it!"
        % CogdoStomperName,
