...
QuestDialogDict = {
 ...
 1084: {
  QUEST: 'I want to enter a baking contest.\x07But ailas I cannot bake. I always wanted to be in a baking contest\x07The winner gets to get a vacation to Toontown.\x07But not sure why would you would want to go there.\x07Anyways, my friend Nayla owns a bakery\x07Maybe go see if they want to help us out.\x07Hopefully I dont get caught cheating_where_'},
 1085: {
 ...
 1089: {
  QUEST: 'Hey thanks for the pies.\x07Now lets test their taste.\x07WOW these pies are GOOD.\x07WAIT…\x07These taste like Cream Pies\x07AND IM ALLERGIC TO CREAM PIES\x07Please go clarify with Nayla to make sure the pies are okay._where_'},
 1090: {
  QUEST: 'Why are you back…\x07Oh right!\x07I feel really bad now\x07Please give this free batch of pies to Nayla. Pronto before Ma eats more of them.\x07And please tell her im very sorry._where_',
