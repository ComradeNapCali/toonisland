    ...
    if showCannon:
        ...
        reactIval = Parallel(
            ...
            Sequence(
                Wait(0.0),
                LerpPosInterval(
                    cannonHolder, 2.0, posFinal, startPos=posInit, blendType="easeInOut"
                ),
                Parallel(
                    LerpHprInterval(
                        barrel,
                ...
                LerpPosInterval(
                    cannonHolder, 1.0, posInit, startPos=posFinal, blendType="easeInOut"
                ),
            ),
            Sequence(
                Wait(0.0),
        ...
        if hitCount == 1:
            sival = Sequence(
                Parallel(reactIval, MovieUtil.createSuitStunInterval(suit, 0.3, 1.3)),
                Wait(0.0),
