...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
 ...
 'sb1': {'name': TTLocalizer.SuitDrudge,
        'singularname': TTLocalizer.SuitDrudgeS,
        'pluralname': TTLocalizer.SuitDrudgeP,
        'level': 0,
        'hp':(6,12,20,30,42),
        'def':(2,5,10,12,15),
        'freq':(50,30,10,5,5),
        ...
        'attacks':
                ...
                ('PickPocket',
                    ...
                    (25,30,35,40,45),
                    (50,50,50,50,50)))},
 'sb2': {'name': TTLocalizer.SuitSuckUp,
       'singularname': TTLocalizer.SuitSuckUpS,
       'pluralname': TTLocalizer.SuitSuckUpP,
       'level': 1,
       'hp':(12,20,30,42,56),
       'def':(5,10,15,20,25),
       'freq':(50,30,10,5,5),
       ...
       'attacks':
                ...
                ('Liquidate',
                    ...
                    (50,60,70,80,90),
                    (50,50,50,50,50)))},
 'sb3': {'name': TTLocalizer.SuitKissUp,
        'singularname': TTLocalizer.SuitKissUpS,
        'pluralname': TTLocalizer.SuitKissUpP,
        'level': 2,
        'hp':(20,30,42,56,72),
        'def':(10,15,20,25,30),
        'freq':(50,30,10,5,5),
        ...
        'attacks':
                ...
                ('MumboJumbo',
                    ...
                    (50,60,70,80,90),
                    (20,20,20,20,20)))},
 'sb4': {'name': TTLocalizer.SuitSycophant,
        'singularname': TTLocalizer.SuitSycophantS,
        'pluralname': TTLocalizer.SuitSycophantP,
        'level': 3,
        'hp':(30,42,56,72,90),
        'def':(15,20,25,30,35),
        'freq':(50,30,10,5,5),
        ...
        'attacks':
                ...
                ('HangUp',
                    ...
                    (75,75,75,75,75),
                    (35,35,35,35,35)))},
 'sb5': {'name': TTLocalizer.SuitBootlicker,
        'singularname': TTLocalizer.SuitBootlickerS,
        'pluralname': TTLocalizer.SuitBootlickerP,
        'level': 4,
        'hp':(42,56,72,90,110),
        'def':(20,25,30,35,40),
        'freq':(50,30,10,5,5),
        ...
        'attacks':
                ...
                ('FingerWag',
                    ...
                    (50,55,65,75,80),
                    (35,35,35,35,35)))},
 'sb6': {'name': TTLocalizer.SuitToady,
        'singularname': TTLocalizer.SuitToadyS,
        'pluralname': TTLocalizer.SuitToadyP,
        'level': 5,
        'hp':(56,72,90,110,132),
        'def':(25,30,35,40,45),
        'freq':(50,30,10,5,5),
        ...
        'attacks':
                ...
                ('WriteOff',
                    ...
                    (60,65,75,85,90),
                    (15,15,15,15,15)))},
 'sb7': {'name': TTLocalizer.SuitApplePolisher,
        'singularname': TTLocalizer.SuitApplePolisherS,
        'pluralname': TTLocalizer.SuitApplePolisherP,
        'level': 6,
        'hp':(72,90,110,132,156),
        'def':(30,35,40,45,50),
        'freq':(50,30,10,5,5),
        ...
        'attacks':
                ...
                ('PeckingOrder',
                    ...
                    (70,75,80,85,95),
                    (30,30,30,30,30)))},
 'sb8': {'name': TTLocalizer.SuitBouncer,
        'singularname': TTLocalizer.SuitBouncerS,
        'pluralname': TTLocalizer.SuitBouncerP,
        'level': 7,
        'hp':(90,110,132,156,200,462,992,1722,2652,3382,4112,4842,5572,6302),
        'def':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
        'freq':(50,30,10,5,5),
