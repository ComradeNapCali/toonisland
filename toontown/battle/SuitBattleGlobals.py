...
SuitAttributes = {
    ...
    "ds": {
        ...
        "acc": (35, 40, 45, 50, 55),
        "attacks": (
            ("Canned", (5, 6, 8, 10, 12), (60, 75, 80, 85, 90), (25, 25, 25, 25, 25)),
            (
                "Downsize",
                (8, 9, 11, 13, 15),
                (50, 65, 70, 75, 80),
    ...
    "cr": {
        ...
        "acc": (35, 40, 45, 50, 55),
        "attacks": (
            ("Canned", (6, 7, 8, 9, 10), (60, 75, 80, 85, 90), (20, 20, 20, 20, 20)),
            (
                "EvilEye",
                (12, 15, 18, 21, 24),
                (60, 70, 75, 80, 90),
    ...
    "tm": {
        ...
        "acc": (45, 50, 55, 60, 65),
        "attacks": (
            ("ClipOnTie", (2, 2, 3, 3, 4), (75, 75, 75, 75, 75), (15, 15, 15, 15, 15)),
    ...
    "gh": {
        ...
        "acc": (70, 75, 80, 82, 85),
        "attacks": (
            ("RubberStamp", (4, 3, 3, 2, 1), (90, 70, 50, 30, 10), (40, 30, 20, 10, 5)),
    ...
    "tw": {
        ...
        "acc": (65, 70, 75, 80, 85),
        "attacks": (
            ("Fired", (3, 4, 5, 5, 6), (75, 75, 75, 75, 75), (75, 5, 5, 5, 5)),
            (
                "GlowerPower",
                (3, 4, 6, 9, 12),
                (95, 95, 95, 95, 95),
    ...
    "bc": {
        ...
        "acc": (70, 75, 80, 82, 85),
        "attacks": (
            ("Audit", (4, 6, 9, 12, 15), (95, 95, 95, 95, 95), (20, 20, 20, 20, 20)),
            (
                "Calculate",
                (4, 6, 9, 12, 15),
                (75, 75, 75, 75, 75),
    ...
    "nc": {
        ...
        "acc": (35, 40, 45, 50, 55),
        "attacks": (
            ("Audit", (5, 6, 8, 10, 12), (60, 75, 80, 85, 90), (15, 15, 15, 15, 15)),
            (
                "Calculate",
                (6, 7, 9, 11, 13),
                (50, 65, 70, 75, 80),
    ...
    "ls": {
        ...
        "acc": (35, 40, 45, 50, 55),
        "attacks": (
            ("Bite", (10, 11, 13, 15, 16), (60, 75, 80, 85, 90), (30, 30, 30, 30, 30)),
    ...
    "dt": {
        ...
        "acc": (65, 70, 75, 80, 85),
        "attacks": (
            ("RubberStamp", (1, 1, 1, 1, 1), (50, 60, 70, 80, 90), (5, 5, 5, 5, 5)),
    ...
    "ac": {
        ...
        "acc": (65, 70, 75, 80, 85),
        "attacks": (
            ("Shake", (4, 6, 9, 12, 15), (75, 75, 75, 75, 75), (15, 15, 15, 15, 15)),
