...
class HydrantInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdles = {ToontownGlobals.ToonIslandCentral: (('tt_a_ara_ttc_hydrant_idle0',
                                        1,
                                        1,
                                        None,
                                        3,
                                       ...
                                       ('tt_a_ara_ttc_hydrant_idleAwesome3',
                                        ...
                                        3,
                                        10)),
     ToontownGlobals.RainbowRise: (('tt_a_ara_ttc_hydrant_idle0',
                                    1,
                                    1,
                                    None,
                                    3,
                                   ...
                                   ('tt_a_ara_ttc_hydrant_idleAwesome3',
                                    ...
                                    3,
                                    10)),
     ToontownGlobals.WitheringWoods: (('tt_a_ara_dga_hydrant_idle0',
                                     3,
                                     10,
                                    ...
                                    ('tt_a_ara_dga_hydrant_idleAwesome3',
                                     ...
                                     3,
                                     10)),
     ToontownGlobals.OliveOasis: (('tt_a_ara_mml_hydrant_idle0',
                                          3,
                                          10,
                                         ...
                                         ('tt_a_ara_mml_hydrant_idleAwesome3',
                                          ...
                                          3,
                                          10)),
     ToontownGlobals.CirrusCircus: (('tt_a_ara_tbr_hydrant_idleShiver1',
                                  1,
                                  1,
                                  None,
                                  3,
                                 ...
                                 ('tt_a_ara_tbr_hydrant_idleAwesome3',
                                  ...
                                  3,
                                  10)),
     ToontownGlobals.MintyMines: (('tt_a_ara_ddl_hydrant_idle0',
                                         3,
                                         10,
                                         None,
                                         0,
                                        ...
                                        ('tt_a_ara_ddl_hydrant_idleAwesome3',
                                         ...
                                         0,
                                         0))}
    ZoneToIdleIntoFightAnims = {ToontownGlobals.ToonIslandCentral: 'tt_a_ara_ttc_hydrant_idleIntoFight',
     ToontownGlobals.RainbowRise: 'tt_a_ara_ttc_hydrant_idleIntoFight',
     ToontownGlobals.WitheringWoods: 'tt_a_ara_dga_hydrant_idleIntoFight',
     ToontownGlobals.OliveOasis: 'tt_a_ara_mml_hydrant_idleIntoFight',
     ToontownGlobals.CirrusCircus: 'tt_a_ara_tbr_hydrant_idleIntoFight',
     ToontownGlobals.MintyMines: 'tt_a_ara_ddl_hydrant_idleIntoFight'}
    ZoneToVictoryAnims = {ToontownGlobals.ToonIslandCentral: 'tt_a_ara_ttc_hydrant_victoryDance',
     ToontownGlobals.RainbowRise: 'tt_a_ara_ttc_hydrant_victoryDance',
     ToontownGlobals.WitheringWoods: 'tt_a_ara_dga_hydrant_victoryDance',
     ToontownGlobals.OliveOasis: 'tt_a_ara_mml_hydrant_victoryDance',
     ToontownGlobals.CirrusCircus: 'tt_a_ara_tbr_hydrant_victoryDance',
     ToontownGlobals.MintyMines: 'tt_a_ara_ddl_hydrant_victoryDance'}
    ZoneToSadAnims = {ToontownGlobals.ToonIslandCentral: 'tt_a_ara_ttc_hydrant_fightSad',
     ToontownGlobals.RainbowRise: 'tt_a_ara_ttc_hydrant_fightSad',
     ToontownGlobals.WitheringWoods: 'tt_a_ara_dga_hydrant_fightSad',
     ToontownGlobals.OliveOasis: 'tt_a_ara_mml_hydrant_fightSad',
     ToontownGlobals.CirrusCircus: 'tt_a_ara_tbr_hydrant_fightSad',
     ToontownGlobals.MintyMines: 'tt_a_ara_ddl_hydrant_fightSad'}
    ZoneToFightAnims = {ToontownGlobals.ToonIslandCentral: ('tt_a_ara_ttc_hydrant_fightBoost', 'tt_a_ara_ttc_hydrant_fightCheer', 'tt_a_ara_ttc_hydrant_fightIdle'),
     ...
     ToontownGlobals.WitheringWoods: ('tt_a_ara_dga_hydrant_fightBoost', 'tt_a_ara_dga_hydrant_fightCheer', 'tt_a_ara_dga_hydrant_fightIdle'),
     ToontownGlobals.OliveOasis: ('tt_a_ara_mml_hydrant_fightBoost', 'tt_a_ara_mml_hydrant_fightCheer', 'tt_a_ara_mml_hydrant_fightIdle'),
     ToontownGlobals.CirrusCircus: ('tt_a_ara_tbr_hydrant_fightBoost', 'tt_a_ara_tbr_hydrant_fightCheer', 'tt_a_ara_tbr_hydrant_fightIdle'),
     ToontownGlobals.MintyMines: ('tt_a_ara_ddl_hydrant_fightBoost', 'tt_a_ara_ddl_hydrant_fightCheer', 'tt_a_ara_ddl_hydrant_fightIdle')}
    ...
    def setupActor(self, node):
        ...
        if not self.hoodId == ToontownGlobals.CirrusCircus:
    ...
    def hasOverrideIval(self, origAnimName):
        result = False
        if ('fightBoost' in origAnimName or 'fightCheer' in origAnimName) and not self.hoodId == ToontownGlobals.CirrusCircus:
            result = True
        return result
