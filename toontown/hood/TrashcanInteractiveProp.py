...
class TrashcanInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdles = {ToontownGlobals.ToonIslandCentral: (('tt_a_ara_ttc_trashcan_idleTake2',
                                        1,
                                        1,
                                        None,
                                        3,
                                       ...
                                       ('tt_a_ara_ttc_trashcan_idleAwesome3',
                                        ...
                                        3,
                                        10)),
     ToontownGlobals.RainbowRise: (('tt_a_ara_dod_trashcan_idleBounce2',
                                    3,
                                    10,
                                   ...
                                   ('tt_a_ara_dod_trashcan_idleAwesome3',
                                    ...
                                    3,
                                    10)),
     ToontownGlobals.WitheringWoods: (('tt_a_ara_dga_trashcan_idleTake2',
                                     1,
                                     1,
                                     None,
                                     3,
                                    ...
                                    ('tt_a_ara_dga_trashcan_idleAwesome3',
                                     ...
                                     3,
                                     10)),
     ToontownGlobals.OliveOasis: (('tt_a_ara_mml_trashcan_idleBounce0',
                                          3,
                                          10,
                                         ...
                                         ('tt_a_ara_mml_trashcan_idleAwesome3',
                                          ...
                                          3,
                                          10)),
     ToontownGlobals.CirrusCircus: (('tt_a_ara_tbr_trashcan_idleShiver1',
                                  1,
                                  1,
                                  None,
                                  3,
                                 ...
                                 ('tt_a_ara_tbr_trashcan_idleAwesome3',
                                  ...
                                  3,
                                  10)),
     ToontownGlobals.MintyMines: (('tt_a_ara_ddl_trashcan_idleSleep0',
                                         3,
                                         10,
                                         None,
                                         0,
                                        ...
                                        ('tt_a_ara_ddl_trashcan_idleAwesome3',
                                         ...
                                         0,
                                         0))}
    ZoneToIdleIntoFightAnims = {ToontownGlobals.ToonIslandCentral: 'tt_a_ara_ttc_trashcan_idleIntoFight',
    ...
    ZoneToVictoryAnims = {ToontownGlobals.ToonIslandCentral: 'tt_a_ara_ttc_trashcan_victoryDance',
    ...
    ZoneToSadAnims = {ToontownGlobals.ToonIslandCentral: 'tt_a_ara_ttc_trashcan_fightSad',
    ...
    ZoneToFightAnims = {ToontownGlobals.ToonIslandCentral: ('tt_a_ara_ttc_trashcan_fightBoost', 'tt_a_ara_ttc_trashcan_fightCheer', 'tt_a_ara_ttc_trashcan_fightIdle'),
     ...
     ToontownGlobals.WitheringWoods: ('tt_a_ara_dga_trashcan_fightBoost', 'tt_a_ara_dga_trashcan_fightCheer', 'tt_a_ara_dga_trashcan_fightIdle'),
     ToontownGlobals.OliveOasis: ('tt_a_ara_mml_trashcan_fightBoost',
                                         'tt_a_ara_mml_trashcan_fightCheer0',
                                         'tt_a_ara_mml_trashcan_fightCheer1',
                                         'tt_a_ara_mml_trashcan_fightIdle'),
     ToontownGlobals.CirrusCircus: ('tt_a_ara_tbr_trashcan_fightBoost', 'tt_a_ara_tbr_trashcan_fightCheer', 'tt_a_ara_tbr_trashcan_fightIdle'),
     ToontownGlobals.MintyMines: ('tt_a_ara_ddl_trashcan_fightBoost', 'tt_a_ara_ddl_trashcan_fightCheer', 'tt_a_ara_ddl_trashcan_fightIdle')}
