...
class CSHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def startup(self):
        ...
        self.fatalElev = DistributedFactoryElevatorExtAI.DistributedFactoryElevatorExtAI(self.air, self.air.factoryMgr, ToontownGlobals.SellbotFatalInt, 2, antiShuffle=0, minLaff=mins[2])
