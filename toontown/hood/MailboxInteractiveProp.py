...
class MailboxInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdleIntoFightAnims = {
        ToontownGlobals.ToonIslandCentral: "tt_a_ara_ttc_mailbox_idleIntoFight",
        ToontownGlobals.RainbowRise: "tt_a_ara_dod_mailbox_idleIntoFight",
        ToontownGlobals.WitheringWoods: "tt_a_ara_dga_mailbox_idleIntoFight",
        ToontownGlobals.OliveOasis: "tt_a_ara_mml_mailbox_idleIntoFight",
        ToontownGlobals.CirrusCircus: "tt_a_ara_tbr_mailbox_idleIntoFight",
        ToontownGlobals.MintyMines: "tt_a_ara_ddl_mailbox_idleIntoFight",
    }
    ZoneToVictoryAnims = {
        ToontownGlobals.ToonIslandCentral: "tt_a_ara_ttc_mailbox_victoryDance",
        ToontownGlobals.RainbowRise: "tt_a_ara_dod_mailbox_victoryDance",
        ToontownGlobals.WitheringWoods: "tt_a_ara_dga_mailbox_victoryDance",
        ToontownGlobals.OliveOasis: "tt_a_ara_mml_mailbox_victoryDance",
        ToontownGlobals.CirrusCircus: "tt_a_ara_tbr_mailbox_victoryDance",
        ToontownGlobals.MintyMines: "tt_a_ara_ddl_mailbox_victoryDance",
    }
    ZoneToSadAnims = {
        ToontownGlobals.ToonIslandCentral: "tt_a_ara_ttc_mailbox_fightSad",
        ToontownGlobals.RainbowRise: "tt_a_ara_dod_mailbox_fightSad",
        ToontownGlobals.WitheringWoods: "tt_a_ara_dga_mailbox_fightSad",
        ToontownGlobals.OliveOasis: "tt_a_ara_mml_mailbox_fightSad",
        ToontownGlobals.CirrusCircus: "tt_a_ara_tbr_mailbox_fightSad",
        ToontownGlobals.MintyMines: "tt_a_ara_ddl_mailbox_fightSad",
    }
    ZoneToFightAnims = {
        ToontownGlobals.ToonIslandCentral: (
