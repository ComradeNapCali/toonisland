...
class ChrysanthemumEffect(NodePath, EffectController):
    def __init__(self):
        ...
        self.effectModel = loader.loadModel(
            "phase_4/models/props/tt_m_efx_ext_fireworkBurst_tflip"
        )
    ...
    def createTrack(self):
        ...
        fadeBlast = self.effectModel.colorScaleInterval(
            1.25, fadeColor, startColorScale=Vec4(1, 1, 0.8, 1), blendType="easeIn"
        )
        ...
        fadeBlast2 = self.effectModel2.colorScaleInterval(
            1.0, fadeColor, startColorScale=Vec4(1, 1, 0.8, 1), blendType="easeIn"
        )
        ...
        starsFadeOut = self.stars.colorScaleInterval(
            1.0, Vec4(0, 0, 0, 0), startColorScale=self.effectColor, blendType="easeIn"
        )
