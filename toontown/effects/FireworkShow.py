...
class FireworkShow(NodePath):
    ...
    def rV():
        return Vec3(
            random.randint(-60, 60), random.randint(10, 30), random.randint(125, 150)
        )
    ...
    showData = {
        ToontownGlobals.JULY4_FIREWORKS: [
            ...
            [FireworkType.Ring, Vec3(90, 0, 100), rP(), rS(), rC(), rC(), rT(), 3.0],
    ...
    showData[ToontownGlobals.COMBO_FIREWORKS] = showData[
        ToontownGlobals.NEWYEARS_FIREWORKS
    ]
    sectionData = {
        ToontownGlobals.JULY4_FIREWORKS: [
    ...
    def beginSection(self, startIndex, endIndex, offset):
        ...
        if showMusic:
            ...
            musicOffset = (
                self.getDuration(0, startIndex)
                - self.getDuration(startIndex, startIndex)
                + offset
            )
            sectionIval.append(
                Func(base.musicMgr.request, showMusic, priority=2, looping=False)
            )
        ...
        self.delaySectionStart = FrameDelayedCall(
            "delaySectionStart", self.startCurSection, frames=24
        )
        ...
        for section in self.sectionData.get(self.showType):
            ...
            if timestamp < sectionDur:
                ...
                taskMgr.doMethodLater(
                    time,
                    self.beginSection,
                    "beginSection" + str(startIndex) + str(endIndex),
