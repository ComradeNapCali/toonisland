...
class BodyShop(StateData.StateData):
    ...
    def enter(self, toon, shopsVisited=[]):
        ...
        self.headChoice = ToonDNA.toonHeadTypes.index(
            self.dna.head
        ) - ToonDNA.getHeadStartIndex(self.species)
        self.torsoStart = 0
    ...
    def __swapLegs(self, offset):
        ...
        self.__updateScrollButtons(
            self.legChoice, length, self.legStart, self.legLButton, self.legRButton
        )
    ...
    def changeBody(self):
        ...
        newHeadIndex = ToonDNA.toonHeadTypes.index(newHead) - ToonDNA.getHeadStartIndex(
        ...
        oldHeadIndex = ToonDNA.toonHeadTypes.index(oldHead) - ToonDNA.getHeadStartIndex(
