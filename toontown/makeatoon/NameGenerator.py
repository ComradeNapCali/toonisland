...
class NameGenerator:
    ...
    def findWidestName(self):
        ...
        longestName = self.findWidestInList(
            self.text, [longestBoyName, longestGirlName]
        )
        return longestName
    ...
    def findWidestNameWord(self):
        widestWord = self.findWidestInList(
            self.text,
            [
    ...
    def randomName(self, boy=0, girl=0):
        ...
        titleFlag = 0
        if (
            uberFlag == "title-first"
            or uberFlag == "title-last"
            or uberFlag == "title-first-last"
        ):
            titleFlag = 1
        firstFlag = 0
        if (
    ...
    def totalNames(self):
        ...
        ) + len(self.neutralTitles) * len(self.boyFirsts)
        ...
        totalTitleFirstLasts = (
            neutralTitleFirstLasts + boyTitleFirstLasts + girlTitleFirstLasts
        )
