...
class HoodMgr(DirectObject.DirectObject):
    ...
    ToonIslandCentralInitialDropPoints = (
    ...
    ToonIslandCentralTunnelDropPoints = (
    ...
    dropPoints = {
        ...
        ToontownGlobals.Tutorial: ([130.9, -8.6, -1.3, 105.5, 0, 0],),
    ...
    hoodId2Name = {
        ...
        ToontownGlobals.CirrusCircus: "br",
        ToontownGlobals.OliveOasis: "mm",
        ToontownGlobals.WitheringWoods: "dg",
        ToontownGlobals.OutdoorZone: "oz",
        ToontownGlobals.CirrusCircus: "ff",
        ToontownGlobals.GoofySpeedway: "gs",
        ToontownGlobals.MintyMines: "dl",
    ...
    def getPlaygroundCenterFromId(self, hoodId):
        ...
        if dropPointList:
            ...
            self.notify.warning(
                "getPlaygroundCenterFromId: No such hood name as: " + str(hoodId)
            )
