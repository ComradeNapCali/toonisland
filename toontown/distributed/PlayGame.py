...
class PlayGame(StateData.StateData):
    ...
    Hood2ClassDict = {
        ToontownGlobals.ToonIslandCentral: TTHood.TTHood,
        ToontownGlobals.RainbowRise: DDHood.DDHood,
        ToontownGlobals.CirrusCircus: BRHood.BRHood,
        ToontownGlobals.OliveOasis: MMHood.MMHood,
        ToontownGlobals.WitheringWoods: DGHood.DGHood,
        ToontownGlobals.MintyMines: DLHood.DLHood,
    ...
    Hood2StateDict = {
        ToontownGlobals.ToonIslandCentral: "TTHood",
        ToontownGlobals.RainbowRise: "DDHood",
        ToontownGlobals.CirrusCircus: "BRHood",
        ToontownGlobals.OliveOasis: "MMHood",
        ToontownGlobals.WitheringWoods: "DGHood",
        ToontownGlobals.MintyMines: "DLHood",
    ...
    def __init__(self, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                ...
                State.State(
                    "BossbotHQ", self.enterBossbotHQ, self.exitBossbotHQ, ["quietZone"]
                ),
                State.State(
                    "SellbotHQ", self.enterSellbotHQ, self.exitSellbotHQ, ["quietZone"]
                ),
                State.State(
                    "CashbotHQ", self.enterCashbotHQ, self.exitCashbotHQ, ["quietZone"]
                ),
                State.State(
                    "LawbotHQ", self.enterLawbotHQ, self.exitLawbotHQ, ["quietZone"]
                ),
                State.State(
                    "TutorialHood",
                ...
                State.State(
                    "PartyHood", self.enterPartyHood, self.exitPartyHood, ["quietZone"]
                ),
            ],
            "start",
            "start",
                ...
                if avId == -1:
                    ...
                    if owner == None:
                        ...
                        if friend != None:
                            ...
                            loader.beginBulkLoad(
                                "hood",
                                TTLocalizer.HeadingToFriend % avName,
                                count,
                                1,
                                TTLocalizer.TIP_ESTATE,
                                0,
                        ...
                        loader.beginBulkLoad(
                            "hood",
                            TTLocalizer.HeadingToEstate % avName,
                            count,
                            1,
                            TTLocalizer.TIP_ESTATE,
                            0,
    ...
    def goHomeFailed(self, task):
        ...
        if failedToVisitAvId > 0:
            message = (
                TTLocalizer.EstateTeleportFailedNotFriends
                % base.cr.identifyAvatar(failedToVisitAvId).getName()
            )
        else:
