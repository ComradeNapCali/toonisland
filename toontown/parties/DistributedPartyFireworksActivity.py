from panda3d.core import Vec3, OmniBoundingVolume, AlphaTestAttrib, RenderAttrib
...
class DistributedPartyFireworksActivity(DistributedPartyActivity, FireworkShowMixin):
    ...
    def __init__(self, cr):
        ...
        FireworkShowMixin.__init__(
            self, restorePlaygroundMusic=True, startDelay=FireworksPostLaunchDelay
        )
