...
PartyStatus = PythonUtil.Enum(
    ("Pending", "Cancelled", "Finished", "CanStart", "Started", "NeverStarted")
)
...
ChangePartyFieldErrorCode = PythonUtil.Enum(
    ("AllOk", "ValidationError", "DatabaseError", "AlreadyStarted", "AlreadyRefunded")
)
...
GoToPartyStatus = PythonUtil.Enum(
    ("AllowedToGo", "PartyFull", "PrivateParty", "PartyOver", "PartyNotActive")
)
PlayGroundToPartyClockColors = {
    ...
    "toon_island_central": (77.0 / 255.0, 137.0 / 255.0, 52.0 / 255.0, 1.0),
}
...
CogPinataPushHeadFactor = CogPinataPushBodyFactor * abs(
    CogActivityHitPointsForHead - CogActivityHitPoints
)
...
TugOfWarTargetRateList = [(8.0, 6), (5.0, 7), (6.0, 8), (6.0, 10), (7.0, 11), (8.0, 12)]
...
MUSIC_GAP = 2.5
PhaseToMusicData = {
    3.5: {"TC_SZ.ogg": [TTLocalizer.MusicTcSz, 57]},
    3: {
    ...
    6: {
        "DD_SZ.ogg": [TTLocalizer.MusicDdSz, 33],
...
PhaseToMusicData40 = {
    ...
    7: {
        "encntr_general_bg_indoor.ogg": [TTLocalizer.MusicEncntrGeneralBgIndoor, 31],
        "encntr_suit_winning_indoor.ogg": [
            TTLocalizer.MusicEncntrGeneralSuitWinningIndoor,
            36,
        ],
    },
    8: {
        "DL_nbrhood.ogg": [TTLocalizer.MusicDlNbrhood, 30],
        "DG_SZ.ogg": [TTLocalizer.MusicDgSz, 48],
        "DL_SZ.ogg": [TTLocalizer.MusicDlSz, 33],
        "TB_SZ.ogg": [TTLocalizer.MusicTbSz, 54],
    },
    ...
    11: {
        "LB_juryBG.ogg": [TTLocalizer.MusicLbJurybg, 30],
