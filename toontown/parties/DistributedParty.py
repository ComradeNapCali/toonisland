...
class DistributedParty(DistributedObject.DistributedObject):
    ...
    def setPartyInfoTuple(self, partyInfoTuple):
        ...
        base.partyHasJukebox = (
            PartyGlobals.ActivityIds.PartyJukebox in allActIds
        ...
        for activityBase in self.partyInfo.activityList:
            fillGrid(
                activityBase.x,
                activityBase.y,
                PartyGlobals.ActivityInformationDict[activityBase.activityId][
                    "gridsize"
                ],
            )
    ...
    def loadGrass(self):
        ...
        for i in range(numTufts):
            ...
            g.setPos(
                pos[0] + random.randint(-8, 8), pos[1] + random.randint(-8, 8), 0.0
            )
    ...
    def startPartyClock(self):
        ...
        timePartyWillEnd = self.partyStartedTime + datetime.timedelta(
