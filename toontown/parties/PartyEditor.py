...
class PartyEditor(FSM):
    ...
    def initElementList(self):
        ...
        isWinter = (
            ToontownGlobals.WINTER_DECORATIONS in holidayIds
            or ToontownGlobals.WACKY_WINTER_DECORATIONS in holidayIds
        )
        ...
        for activityId in PartyGlobals.PartyEditorActivityOrder:
            if (
                not isVictory
                and activityId in PartyGlobals.VictoryPartyActivityIds
                or not isWinter
                and activityId in PartyGlobals.WinterPartyActivityIds
                or not isValentine
                ...
                isVictory
                and activityId in PartyGlobals.VictoryPartyReplacementActivityIds
                or isWinter
                and activityId in PartyGlobals.WinterPartyReplacementActivityIds
                or isValentine
        ...
        for decorationId in PartyGlobals.DecorationIds:
            if (
                not isVictory
                and decorationId in PartyGlobals.VictoryPartyDecorationIds
                or not isWinter
                and decorationId in PartyGlobals.WinterPartyDecorationIds
                or not isValentine
                ...
                isVictory
                and decorationId in PartyGlobals.VictoryPartyReplacementDecorationIds
                or isValentine
    ...
    def scrollItemChanged(self):
        ...
        if self.elementList["items"][self.elementList.getSelectedIndex()].isDecoration:
            self.partyPlanner.instructionLabel[
                "text"
            ] = TTLocalizer.PartyPlannerEditorInstructionsClickedElementDecoration
        else:
            self.partyPlanner.instructionLabel[
                "text"
            ] = TTLocalizer.PartyPlannerEditorInstructionsClickedElementActivity
    ...
    def buyCurrentElement(self):
        if self.currentElement:
            ...
            if purchaseSuccessful:
                ...
                self.partyPlanner.instructionLabel[
                    "text"
                ] = TTLocalizer.PartyPlannerEditorInstructionsNoRoom
    ...
    def mouseEnterTrash(self, mouseEvent):
        ...
        self.partyPlanner.instructionLabel[
            "text"
        ] = TTLocalizer.PartyPlannerEditorInstructionsTrash
    ...
    def enterIdle(self, fromDragging=False):
        ...
        self.partyPlanner.instructionLabel[
            "text"
        ] = TTLocalizer.PartyPlannerEditorInstructionsIdle
    ...
    def updateCostsAndBank(self):
        ...
        self.partyPlanner.costLabel["text"] = (
            TTLocalizer.PartyPlannerTotalCost % newCost
        )
    ...
    def enterDraggingElement(self):
        ...
        if self.currentElement.isDecoration:
            self.partyPlanner.instructionLabel[
                "text"
            ] = TTLocalizer.PartyPlannerEditorInstructionsDraggingDecoration
        else:
            self.partyPlanner.instructionLabel[
                "text"
            ] = TTLocalizer.PartyPlannerEditorInstructionsDraggingActivity
