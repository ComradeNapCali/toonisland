from toontown.parties.DistributedPartyJukeboxActivityBase import (
...
class DistributedPartyValentineJukeboxActivity(DistributedPartyJukeboxActivityBase):
    ...
    def load(self):
        ...
        newTexture = loader.loadTexture(
            "phase_13/maps/tt_t_ara_pty_jukeboxValentineA.jpg",
            "phase_13/maps/tt_t_ara_pty_jukeboxValentineA_a.rgb",
        )
