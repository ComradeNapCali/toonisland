...
class Party(Place.Place):
    ...
    def __init__(self, loader, avId, zoneId, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                ...
                State.State(
                    "fishing", self.enterFishing, self.exitFishing, ["walk", "stopped"]
                ),
                State.State(
                    "activity",
                    self.enterActivity,
    ...
    def load(self):
        ...
        if (
            hasattr(base.localAvatar, "aboutToPlanParty")
            and base.localAvatar.aboutToPlanParty
        ):
    ...
    def __updateLocalAvatarTeleportIn(self, requestStatus):
        ...
        if hasattr(base, "distributedParty"):
            ...
            self.accept(
                "generate-" + str(base.distributedParty.partyInfo.hostId),
                self.__setPartyHat,
            )
            self.__setPartyHat()
        else:
