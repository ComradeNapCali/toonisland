...
class QuestMap(DirectFrame):
    ...
    def load(self):
        ...
        self.tInfo = DirectLabel(parent=self.cogInfoFrame, text_fg=cogInfoTextColor, text='', text_pos=textPos, text_scale=textScale, geom=tIcon, geom_pos=(0, 0, 0), geom_scale=0.6, relief=None)
    ...
    def updateCogInfo(self):
        ...
        self.tInfo['text'] = '%s%%' % currPercentage[4]
        return
