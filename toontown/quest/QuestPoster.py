...
class QuestPoster(DirectFrame):
    ...
    def showChoicePoster(self, questId, fromNpcId, toNpcId, rewardId, callback):
        ...
        if not base.cr.isPaid() and (
            questId == 401
            or hasattr(quest, "getLocation")
            and quest.getLocation() == 1000
            or hoodId == 1000
        ):
    ...
    def update(self, questDesc):
        ...
        fComplete = (
            quest.getCompletionStatus(base.localAvatar, questDesc) == Quests.COMPLETE
        )
        ...
        if (
            ...
            or quest.getType() == Quests.DeliverItemQuest
        ):
            frameBgColor = "red"
            ...
            quest.getType() == Quests.ForemanQuest
            or quest.getType() == Quests.SupervisorQuest
        ):
            frameBgColor = "blue"
            bookModel = loader.loadModel("phase_3.5/models/gui/stickerbook_gui")
            ...
            quest.getType() == Quests.ForemanNewbieQuest
            or quest.getType() == Quests.SupervisorNewbieQuest
        ):
            frameBgColor = "blue"
            bookModel = loader.loadModel("phase_3.5/models/gui/stickerbook_gui")
