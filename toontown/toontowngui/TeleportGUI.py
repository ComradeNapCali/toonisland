...
class TeleportGUI(DirectFrame, StateData.StateData):
    ...
    def __init__(self, toon):
        DirectFrame.__init__(
            ...
            pos=(0.0, 0.0, 0.05),
            image_scale=(1.8, 1, 1.4),
            image_pos=(0, 0, -0.05),
            image_color=ToontownGlobals.GlobalDialogColor,
            text=TTLocalizer.TeleportGUITitle,
            text_scale=0.12,
            text_pos=(0, 0.5),
    ...
    def load(self):
        ...
        for zonePair in zonesForTeleport:
            ...
            zoneInfo = (
                zone,
                list(ToontownGlobals.hood2Id.keys())[zonesForTeleport.index(zonePair)],
            )
        ...
        for zone in teleportZones:
            ...
            zoneName = DirectButton(
                ...
                textMayChange=0,
                command=self.selectZone,
                extraArgs=[zone],
            )
            self.zones.append(zoneName)
            setattr(self, "{0}Name".format(zone[0]), zoneName)
            zoneThumb = OnscreenImage(
                image="phase_3/maps/zones/zone_" + str(zone[0]) + ".jpg",
        ...
        self.scrollList = DirectScrolledList(
            ...
            decButton_pos=(0.025, 0, 0.52),
            decButton_image3_color=Vec4(1, 1, 1, 0.2),
            itemFrame_pos=(-0.237, 0, 0.41),
            itemFrame_scale=1.0,
            itemFrame_relief=DGG.SUNKEN,
            itemFrame_frameSize=(-0.10, 0.66, -0.98, 0.07),
        ...
        self.play = DirectButton(
            parent=hidden,
            relief=None,
            text=TTLocalizer.TeleportGUITeleport,
            image=(
