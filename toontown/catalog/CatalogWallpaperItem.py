...
WallpaperTypes = {
    ...
    1820: (
        "phase_5.5/maps/stars3.jpg",
        (CT_BLUE2, CT_PINK2, CT_RED, CT_WHITE),
        (0,),
        180,
    ),
    ...
    2000: (
        "phase_5.5/maps/flat_wallpaper1.jpg",
    ...
    2020: (
        "phase_5.5/maps/flat_wallpaper1.jpg",
        (CT_BEIGE2, CT_BLUE2, CT_PINK2, CT_BEIGE, CT_RED),
        (1070,),
        180,
    ),
    ...
    2210: ("phase_5.5/maps/wall_paper_car_neutral.jpg", CTFlatColor, (0, 1000), 180),
    2300: (
        "phase_5.5/maps/wall_paper_football_neutral.jpg",
        CTFlatColor,
        (0, 1080),
        180,
    ),
    ...
    2500: (
        "phase_5.5/maps/wall_paper_vine_neutral.jpg",
        CTFlatColorAll,
        (0, 1090),
        180,
    ),
    ...
    2910: (
        "phase_5.5/maps/UWwallPaperAngelFishColor.jpg",
        CTWhite,
        (0, 1120, 1160),
        180,
    ),
    ...
    2980: (
        "phase_5.5/maps/UWwaterFloor1.jpg",
    ...
    3500: (
        "phase_5.5/maps/UWwallPaperShells.jpg",
    ...
    11000: (
        "phase_5.5/maps/wall_paper_snowflakes.jpg",
        CTWhite,
        (0, 11000, 11010),
        400,
    ),
    11100: ("phase_5.5/maps/wall_paper_hollyleaf.jpg", CTWhite, (0, 11000, 11010), 400),
    11200: ("phase_5.5/maps/wall_paper_snowman.jpg", CTWhite, (0, 11000, 11010), 400),
    12000: ("phase_5.5/maps/VdayWall1.jpg", CTWhite, (0, 12000, 12010, 12020), 400),
    12100: ("phase_5.5/maps/VdayWall2.jpg", CTWhite, (0, 12000, 12010, 12020), 400),
    12200: ("phase_5.5/maps/VdayWall3.jpg", CTWhite, (0, 12000, 12010, 12020), 400),
    12300: ("phase_5.5/maps/VdayWall4.jpg", CTWhite, (0, 12000, 12010, 12020), 400),
...
class CatalogWallpaperItem(CatalogSurfaceItem):
    def makeNewItem(
        self, patternIndex, colorIndex=None, borderIndex=0, borderColorIndex=0
    ):
            ...
            for borderKey in borderKeys:
                ...
                for borderColorIndex in range(numBorderColors):
                    ...
                    for n in range(len(colors)):
                        list.append(
                            CatalogWallpaperItem(index, n, borderKey, borderColorIndex)
                        )
