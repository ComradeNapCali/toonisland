...
FurnitureTypes = {
    ...
    105: (
        "phase_5.5/models/estate/chairAdesat",
        None,
        {
    ...
    205: (
        "phase_5.5/models/estate/regular_bed_desat",
        None,
        {
            0: (
                ("**/bar*", woodColors[0]),
    ...
    460: (
        "phase_5.5/models/estate/tt_m_prp_int_fireplace_coral",
        None,
        None,
        1250,
        None,
    ...
    470: (
        "phase_5.5/models/estate/tt_m_prp_int_fireplace_square",
        None,
        None,
        1100,
        None,
    ...
    480: (
        "phase_5.5/models/estate/tt_m_prp_int_fireplace_round",
        None,
        None,
        1100,
        None,
    ...
    490: (
        "phase_5.5/models/estate/tt_m_prp_int_fireplace_girlee",
        None,
        None,
        1100,
        None,
    ...
    491: (
        "phase_5.5/models/estate/tt_m_prp_int_fireplace_bugRoom",
        None,
        None,
        1100,
        None,
    ...
    492: (
        "phase_5.5/models/estate/tt_m_prp_int_fireplace_caramelApple",
        None,
        None,
        1100,
        None,
    ...
    500: ("phase_5.5/models/estate/closetBoy", None, None, 500, FLCloset, 0.85),
    502: ("phase_5.5/models/estate/closetBoy", None, None, 500, FLCloset, 1.0),
    504: ("phase_5.5/models/estate/closetBoy", None, None, 500, FLCloset, 1.15),
    506: ("phase_5.5/models/estate/closetBoy", None, None, 500, FLCloset, 1.3),
    508: ("phase_5.5/models/estate/closetBoy", None, None, 500, FLCloset, 1.3),
    510: ("phase_5.5/models/estate/closetGirl", None, None, 500, FLCloset, 0.85),
    512: ("phase_5.5/models/estate/closetGirl", None, None, 500, FLCloset, 1.0),
    514: ("phase_5.5/models/estate/closetGirl", None, None, 500, FLCloset, 1.15),
    516: ("phase_5.5/models/estate/closetGirl", None, None, 500, FLCloset, 1.3),
    518: ("phase_5.5/models/estate/closetGirl", None, None, 500, FLCloset, 1.3),
    ...
    625: (
        "phase_5.5/models/estate/lampADesat",
        None,
        {
    ...
    680: (
        "phase_5.5/models/estate/tt_m_ara_int_candlestick",
        None,
        {
    ...
    705: (
        "phase_5.5/models/estate/couch_1personDesat",
        None,
        {
    ...
    715: (
        "phase_5.5/models/estate/couch_2personDesat",
        None,
        {
            0: (("**/*couch", furnitureColors[0]),),
            1: (("**/*couch", furnitureColors[1]),),
    ...
    1015: (
        "phase_5.5/models/estate/rugADesat",
        None,
        {
    ...
    1215: (
        "phase_5.5/models/estate/table_radioDesat",
        None,
        {
    ...
    1260: (
        "phase_5.5/models/estate/TABLE_Bedroom_Desat",
        None,
        {
    ...
    1300: ("phase_5.5/models/estate/jellybeanBank", None, None, 0, FLBank, 1.0),
    1310: ("phase_5.5/models/estate/jellybeanBank", None, None, 0, FLBank, 1.0),
    1320: ("phase_5.5/models/estate/jellybeanBank", None, None, 0, FLBank, 1.0),
    1330: ("phase_5.5/models/estate/jellybeanBank", None, None, 0, FLBank, 1.0),
    1340: ("phase_5.5/models/estate/jellybeanBank", None, None, 0, FLBank, 1.0),
    1350: ("phase_5.5/models/estate/jellybeanBank", None, None, 0, FLBank, 1.0),
    ...
    1450: (
        "phase_5.5/models/estate/tt_m_prp_int_painting_valentine",
        None,
        None,
        425,
        FLPainting,
    ...
    1660: (
        "phase_5.5/models/estate/UWcoralVase",
        None,
        None,
        120,
    ...
    1661: (
        "phase_5.5/models/estate/UWshellVase",
        None,
        None,
        120,
        FLOnTable | FLBillboard,
    ...
    1670: (
        "phase_5.5/models/estate/tt_m_prp_int_roseVase_valentine",
        None,
        None,
        200,
        FLOnTable,
    ...
    1680: (
        "phase_5.5/models/estate/tt_m_prp_int_roseWatercan_valentine",
        None,
        None,
        200,
        FLOnTable,
    ...
    4000: (
        "phase_5.5/models/estate/tt_m_ara_est_accessoryTrunkBoy",
        None,
        None,
        5,
        FLTrunk,
    ...
    4010: (
        "phase_5.5/models/estate/tt_m_ara_est_accessoryTrunkGirl",
        None,
        None,
        5,
        FLTrunk,
    ...
    10000: ("phase_4/models/estate/pumpkin_short", None, None, 200, FLOnTable),
    10010: ("phase_4/models/estate/pumpkin_tall", None, None, 250, FLOnTable),
    10020: (
        "phase_5.5/models/estate/tt_m_prp_int_winter_tree",
        None,
        None,
        500,
        None,
    ...
    10030: (
        "phase_5.5/models/estate/tt_m_prp_int_winter_wreath",
        None,
        None,
        200,
        FLPainting,
...
class CatalogFurnitureItem(CatalogAtticItem.CatalogAtticItem):
    ...
    def needsCustomize(self):
        return (
            ...
            and FurnitureTypes[self.furnitureType][FTColorOptions] != None
        )
