...
MetaItems = {
    ...
    300: getAllClothes(
        301, 302, 303, 304, 305, 308, 401, 403, 404, 405, 407, 451, 452, 453
    ),
    ...
    2910: getChatRange(
        11000, 11005, 11008, 11008, 11012, 11015, 11017, 11019, 11021, 11022
    ),
...
MonthlySchedule = (
    ...
    (9, 1, 9, 30, (CatalogGardenItem(135, 1),)),
    (1, 1, 1, 31, (CatalogGardenItem(135, 1),)),
    (4, 1, 4, 30, (CatalogGardenItem(135, 1),)),
    (6, 1, 6, 30, (CatalogGardenItem(135, 1),)),
    (
        6,
        26,
        7,
    ...
    (6, 5, 7, 1, (CatalogClothingItem(1768, 0), CatalogClothingItem(1769, 0))),
    (
        1,
        1,
        12,
...
WeeklySchedule = (
    ...
    (100, (1, 2020), (2, 2030), (3, 2040), CatalogFurnitureItem(260)),
    (
        300,
        (1, 2020),
        (2, 2030),
    ...
    (300, (1, 2020), (2, 2030), (3, 2040), CatalogFurnitureItem(2000), 5000),
    (100, (1, 2020), (2, 2030), (3, 2040), CatalogFurnitureItem(3000)),
    (
        300,
        (1, 2030),
        (2, 2040),
    ...
    (300, (1, 2030), (2, 2040), (3, 2050), CatalogFurnitureItem(105)),
    (300, (1, 2030), (2, 2040), (3, 2050), CatalogFurnitureItem(205)),
    (300, (1, 2030), (2, 2040), (3, 2050), CatalogFurnitureItem(625)),
    (
        300,
        (1, 2030),
        (2, 2040),
    ...
    (300, (1, 2030), (2, 2040), (3, 2050), CatalogFurnitureItem(715)),
    (
        300,
        (1, 2030),
        (2, 2040),
    ...
    (300, (1, 2030), (2, 2040), (3, 2050), CatalogEmoteItem(14)),
    (300, (1, 2030), (2, 2040), (3, 2050), CatalogFurnitureItem(1260)),
    (
        300,
        (1, 2030),
        (2, 2040),
    ...
    (300, (1, 2030), (2, 2040), (3, 2050), nextAvailablePole),
)
...
class CatalogGenerator:
    ...
    def generateWeeklyCatalog(self, avatar, week, monthlyCatalog):
        ...
        self.notify.debug(
            "Generating catalog for %s for week %s." % (avatar.doId, week)
        )
        if week >= 1 and week <= len(WeeklySchedule):
            ...
            weeklyCatalog += self.__selectItem(
                avatar, get50ItemTrunk, monthlyCatalog, saleItem=0
            )
        if time.time() < 1096617600.0:
            ...
            if (
                not hasPetTrick(weeklyCatalog)
                and not hasPetTrick(avatar.weeklyCatalog)
                and not hasPetTrick(avatar.backCatalog)
            ):
    ...
    def generateBackCatalog(self, avatar, week, previousWeek, weeklyCatalog):
        ...
        if previousWeek < week:
            self.notify.debug(
                "Adding current items from week %s to back catalog" % previousWeek
            )
    ...
    def __getReleasedItemLists(self, dayNumber, weekStart):
        ...
        for monthlyItems in MonthlySchedule:
            ...
            if len(monthlyItems) == 7:
                ...
                endYYYY = year
                list = monthlyItems[4]
            pastStart = year > startYYYY or (
                year == startYYYY
                and (month > startMM or (month == startMM and day >= startDD))
            )
            if pastStart:
        ...
        for item in schedule:
            if callable(item):
                if item == nextAvailablePole:
                    ...
                    self.notify.warning(
                        "Don't know how to interpret function " % repr(name)
                    )
                    item = None
