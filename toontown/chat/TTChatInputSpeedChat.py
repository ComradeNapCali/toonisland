...
scStructure = [
    ...
    [
        ...
        [
            OTPLocalizer.SCMenuPronounsYou,
            550,
            551,
            552,
            553,
    ...
    [OTPLocalizer.SCMenuGagShop, 1600, 1601, 1602, 1603, 1604, 1605, 1606],
    {1: 17},
    {2: 18},
    3,
]
...
cfoMenuStructure = [
    ...
    [OTPLocalizer.SCMenuCFOBattleGoons, 2120, 2121, 2122, 2123, 2124, 2125, 2126],
    2130,
    2131,
    2132,
    2133,
...
cjMenuStructure = [2200, 2201, 2202, 2203, 2204, 2205, 2206, 2207, 2208, 2209, 2210]
ceoMenuStructure = [
    2300,
    2301,
    2302,
...
class TTChatInputSpeedChat(DirectObject.DirectObject):
    ...
    def __init__(self, chatMgr):
        ...
        listenForSCEvent(
            SpeedChatGlobals.SCTerminalLinkedEmoteEvent, self.handleLinkedEmote
        )
        listenForSCEvent(
            SpeedChatGlobals.SCStaticTextMsgEvent, self.handleStaticTextMsg
        )
        ...
        listenForSCEvent(
            SpeedChatGlobals.SCEmoteNoAccessEvent, self.handleEmoteNoAccess
        )
        listenForSCEvent(
            TTSpeedChatGlobals.TTSCToontaskMsgEvent, self.handleToontaskMsg
        )
        listenForSCEvent(
            TTSpeedChatGlobals.TTSCResistanceMsgEvent, self.handleResistanceMsg
        )
        ...
        listenForSCEvent(
            TTSCIndexedTerminal.TTSCIndexedMsgEvent, self.handleStaticTextMsg
        )
