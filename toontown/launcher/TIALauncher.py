...
logfile = os.path.join("user/logs", "TIAD-" + logSuffix + ".log")
...
print("\n\nStarting Toon Island: Aftermath...")
...
class TIALauncher(TIALauncherBase):
    ...
    def __init__(self):
        self.TIAPlayTokenKey = "TIA_PLAYTOKEN"
    ...
    def getPercentPatchComplete(self, bytesWritten):
        if self.totalPatchDownload:
            return TIALauncherBase.getPercentPatchComplete(self, bytesWritten)
        else:
            return 0
    ...
    def launcherMessage(self, msg):
        TIALauncherBase.launcherMessage(self, msg)
