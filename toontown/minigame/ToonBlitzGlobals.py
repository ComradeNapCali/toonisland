...
GameDuration = {
    ToontownGlobals.ToonIslandCentral: 150,
    ToontownGlobals.RainbowRise: 145,
    ToontownGlobals.WitheringWoods: 140,
    ToontownGlobals.OliveOasis: 135,
    ToontownGlobals.CirrusCircus: 130,
    ToontownGlobals.MintyMines: 125,
}
BaseBonusOnCompletion = {
    ToontownGlobals.ToonIslandCentral: 15,
    ToontownGlobals.RainbowRise: 17,
    ToontownGlobals.WitheringWoods: 19,
    ToontownGlobals.OliveOasis: 21,
    ToontownGlobals.CirrusCircus: 23,
    ToontownGlobals.MintyMines: 25,
}
...
ScoreLossPerFallDown = {
    ...
    ToontownGlobals.RainbowRise: -0,
    ToontownGlobals.WitheringWoods: -0,
    ToontownGlobals.OliveOasis: -0,
    ToontownGlobals.CirrusCircus: -0,
    ToontownGlobals.MintyMines: -0,
}
...
SectionWeights = {
    ...
    ToontownGlobals.RainbowRise: ((0, 15), (1, 25), (2, 25), (3, 15), (4, 10), (5, 10)),
    ...
    ToontownGlobals.OliveOasis: ((0, 10), (1, 10), (2, 25), (3, 25), (4, 15), (5, 15)),
    ...
    ToontownGlobals.MintyMines: ((0, 10), (1, 10), (2, 15), (3, 15), (4, 25), (5, 25)),
}
NumSections = {
    ToontownGlobals.ToonIslandCentral: 5,
    ToontownGlobals.RainbowRise: 5,
    ToontownGlobals.WitheringWoods: 5,
    ToontownGlobals.OliveOasis: 5,
    ToontownGlobals.CirrusCircus: 5,
    ToontownGlobals.MintyMines: 5,
}
PercentMaxEnemies = {
    ToontownGlobals.ToonIslandCentral: 50,
    ToontownGlobals.RainbowRise: 60,
    ToontownGlobals.WitheringWoods: 70,
    ToontownGlobals.OliveOasis: 80,
    ToontownGlobals.CirrusCircus: 90,
    ToontownGlobals.MintyMines: 100,
}
PercentMaxTreasures = {
    ToontownGlobals.ToonIslandCentral: 100,
    ToontownGlobals.RainbowRise: 100,
    ToontownGlobals.WitheringWoods: 100,
    ToontownGlobals.OliveOasis: 100,
    ToontownGlobals.CirrusCircus: 100,
    ToontownGlobals.MintyMines: 100,
}
PercentMaxSpawnPoints = {
    ToontownGlobals.ToonIslandCentral: 100,
    ToontownGlobals.RainbowRise: 90,
    ToontownGlobals.WitheringWoods: 80,
    ToontownGlobals.OliveOasis: 70,
    ToontownGlobals.CirrusCircus: 60,
    ToontownGlobals.MintyMines: 50,
}
PercentMaxStompers = {
    ToontownGlobals.ToonIslandCentral: 50,
    ToontownGlobals.RainbowRise: 60,
...
TreasureValueProbability = {1: 4, 2: 3, 3: 2, 4: 1}
BLOCK_H24 = "BlockH24"
...
BLOCK_V3B = "BlockV3B"
BlockTypes = {
    BLOCK_H24: ("00", (0, 0, 0), (0, 0, 0), (1, 1, 1)),
    BLOCK_V24F: ("00", (0, 0, 0), (0, 0, 270), (1, 1, 1)),
    BLOCK_V24B: ("00", (0, 0, 0), (0, 0, 90), (1, 1, 1)),
    BLOCK_H12: ("01", (0, 0, 0), (0, 0, 0), (1, 1, 1)),
    BLOCK_V12F: ("01", (0, 0, 0), (0, 0, 270), (1, 1, 1)),
    BLOCK_V12B: ("01", (0, 0, 0), (0, 0, 90), (1, 1, 1)),
    BLOCK_H6: ("02", (0, 0, 0), (0, 0, 0), (1, 1, 1)),
    BLOCK_V6F: ("02", (0, 0, 0), (0, 0, 270), (0.86, 1, 1)),
    BLOCK_V6B: ("02", (0, 0, 0), (0, 0, 90), (0.86, 1, 1)),
    BLOCK_H3: ("03", (0, 0, 0), (0, 0, 0), (1, 1, 1)),
...
EnemyList0 = [
    ["tm", [(35, 0, 12.65), (30, 0, 12.65), 2]],
    ["tm", [(24, 0, 12.65), (24, 0, 30.0), 2]],
]
TreasureList0 = [
    [(16, 0, 16)],
    [(30, 0, 23)],
...
SpawnPointList3 = [[(2, 0, 16)], [(56, 0, 29.5)], [(108, 0, 9.25)], [(162, 0, 9.25)]]
EnemyList3 = [
    ["p", [(31, 0, 6), (31, 0, 31), 3.5]],
    ["ym", [(31, 0, 31), (31, 0, 6), 3.5]],
    ["bf", [(61, 0, 6), (61, 0, 31), 3.5]],
...
SpawnPointList8 = [
    [(2, 0, 16)],
    [(128, 0, 29.5), (121, 0, 29.5)],
    [(128, 0, 9.25), (121, 0, 9.25)],
]
BlockList9 = [
    [BLOCK_H24, [(0, 0, 12)]],
