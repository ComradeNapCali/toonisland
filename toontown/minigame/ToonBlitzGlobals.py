...
CameraStartingPosition = (-28,
 ...
 0,
 0)
GameDuration = {ToontownGlobals.ToonIslandCentral: 150,
...
BaseBonusOnCompletion = {ToontownGlobals.ToonIslandCentral: 15,
...
ScoreLossPerEnemyCollision = {ToontownGlobals.ToonIslandCentral: -1,
...
ScoreLossPerFallDown = {ToontownGlobals.ToonIslandCentral: -0,
...
ScoreLossPerStomperSquish = {ToontownGlobals.ToonIslandCentral: -1,
 ToontownGlobals.RainbowRise: -1,
 ToontownGlobals.WitheringWoods: -1,
 ToontownGlobals.OliveOasis: -1,
 ToontownGlobals.CirrusCircus: -1,
 ToontownGlobals.MintyMines: -1}
SectionWeights = {ToontownGlobals.ToonIslandCentral: ((0, 25),
                                   (1, 25),
                                   (2, 25),
                                   (3, 15),
                                   (4, 10),
                                   (5, 0)),
 ToontownGlobals.RainbowRise: ((0, 15),
                               (1, 25),
                               (2, 25),
                               (3, 15),
                               (4, 10),
                               (5, 10)),
 ToontownGlobals.WitheringWoods: ((0, 15),
                                (1, 15),
                                (2, 25),
                                (3, 25),
                                (4, 10),
                                (5, 10)),
 ToontownGlobals.OliveOasis: ((0, 10),
                                     (1, 10),
                                     (2, 25),
                                     (3, 25),
                                     (4, 15),
                                     (5, 15)),
 ToontownGlobals.CirrusCircus: ((0, 10),
                             (1, 10),
                             (2, 15),
                             (3, 25),
                             (4, 25),
                             (5, 15)),
 ToontownGlobals.MintyMines: ((0, 10),
                                    (1, 10),
                                    (2, 15),
                                    (3, 15),
                                    (4, 25),
                                    (5, 25))}
NumSections = {ToontownGlobals.ToonIslandCentral: 5,
...
PercentMaxEnemies = {ToontownGlobals.ToonIslandCentral: 50,
...
PercentMaxTreasures = {ToontownGlobals.ToonIslandCentral: 100,
 ...
 ToontownGlobals.MintyMines: 100}
PercentMaxSpawnPoints = {ToontownGlobals.ToonIslandCentral: 100,
...
PercentMaxStompers = {ToontownGlobals.ToonIslandCentral: 50,
 ToontownGlobals.RainbowRise: 60,
 ToontownGlobals.WitheringWoods: 70,
 ToontownGlobals.OliveOasis: 80,
 ToontownGlobals.CirrusCircus: 90,
