...
AREA_DATA[ToontownGlobals.ToonIslandCentral]["CAMERA_INTIAL_POSTION"] = Point3(
    0, 50, 20
)
AREA_DATA[ToontownGlobals.ToonIslandCentral]["DNA_TRIO"] = (
    "phase_4/dna/storage_TT_sz.dna",
    "phase_4/dna/storage_TT.dna",
    "phase_4/dna/toon_island_central_sz.dna",
)
AREA_DATA[ToontownGlobals.ToonIslandCentral]["TRIPOD_OFFSET"] = Point3(0, 0, 7.0)
AREA_DATA[ToontownGlobals.ToonIslandCentral]["START_HPR"] = Point3(
    -87.8752, -0.378549, 0
)
AREA_DATA[ToontownGlobals.ToonIslandCentral]["PATHS"] = (
    [
        Point3(10, 20, 4.025),
        Point3(10, -3, 4.025),
        Point3(32, -5, 4.025),
...
AREA_DATA[ToontownGlobals.ToonIslandCentral]["PATHANIMREL"] = (0, 0, 1, 2)
AREA_DATA[ToontownGlobals.ToonIslandCentral]["ANIMATIONS"] = (
    [("wave", 2.0), (None, 1.0), (None, 1.0)],
    [("slip-forward", 2.0), (None, 1.0), (None, 1.0)],
    [("shrug", 2.0), (None, 1.0)],
)
AREA_DATA[ToontownGlobals.ToonIslandCentral]["MOVEMODES"] = (
    [("walk", 1.0), ("run", 0.4)],
    [("run", 0.4)],
...
AREA_DATA[ToontownGlobals.RainbowRise]["DNA_TRIO"] = (
...
AREA_DATA[ToontownGlobals.RainbowRise]["PATHS"] = (
    [
        Point3(-115.6, 39.4, 5.692),
...
AREA_DATA[ToontownGlobals.RainbowRise]["PATHANIMREL"] = (0, 0, 1, 2, 3)
AREA_DATA[ToontownGlobals.RainbowRise]["ANIMATIONS"] = (
    [("wave", 2.0), (None, 1.0)],
    [("slip-forward", 2.0), (None, 1.0), (None, 1.0)],
    [("shrug", 2.0), (None, 1.0)],
    [(None, 1.0)],
)
AREA_DATA[ToontownGlobals.RainbowRise]["MOVEMODES"] = (
    [("walk", 1.0)],
    [("run", 0.4)],
    [("walk", 1.0), ("sad-walk", 2.5)],
    [("swim", 1.0)],
...
AREA_DATA[ToontownGlobals.WitheringWoods]["DNA_TRIO"] = (
...
AREA_DATA[ToontownGlobals.WitheringWoods]["PATHS"] = (
    [
        Point3(-37.252, 25.513, 0.025),
...
AREA_DATA[ToontownGlobals.WitheringWoods]["PATHANIMREL"] = (0, 0, 1, 2)
AREA_DATA[ToontownGlobals.WitheringWoods]["ANIMATIONS"] = (
    [("wave", 2.0), (None, 1.0)],
    [("jump", 2.0), (None, 1.0), (None, 1.0)],
    [("bow", 2.0), ("happy-dance", 2.0), (None, 1.0)],
)
AREA_DATA[ToontownGlobals.WitheringWoods]["MOVEMODES"] = (
    [("walk", 1.0), ("run", 0.4)],
    [("run", 0.4)],
    [("walk", 1.0), ("run", 0.4)],
)
...
AREA_DATA[ToontownGlobals.OliveOasis]["DNA_TRIO"] = (
...
AREA_DATA[ToontownGlobals.OliveOasis]["PATHS"] = (
    [
        Point3(-42.35, -16.0, -12.476),
...
AREA_DATA[ToontownGlobals.OliveOasis]["PATHANIMREL"] = (0, 0, 1, 2)
AREA_DATA[ToontownGlobals.OliveOasis]["ANIMATIONS"] = (
    [("wave", 2.0), (None, 1.0)],
    [("jump", 2.0), ("slip-forward", 2.0), (None, 1.0), (None, 1.0)],
    [("shrug", 2.0), ("confused", 2.0), (None, 1.0)],
)
AREA_DATA[ToontownGlobals.OliveOasis]["MOVEMODES"] = (
    [("walk", 1.0), ("run", 0.4)],
    [("run", 0.4)],
    [("walk", 1.0), ("sad-walk", 2.5)],
)
...
AREA_DATA[ToontownGlobals.CirrusCircus]["DNA_TRIO"] = (
...
AREA_DATA[ToontownGlobals.CirrusCircus]["PATHS"] = (
    [
        Point3(-82.52, -28.727, 3.009),
...
AREA_DATA[ToontownGlobals.CirrusCircus]["PATHANIMREL"] = (0, 0, 1, 2)
AREA_DATA[ToontownGlobals.CirrusCircus]["ANIMATIONS"] = (
    [("wave", 2.0), (None, 1.0)],
    [("applause", 2.0), ("slip-forward", 2.0), (None, 1.0), (None, 1.0)],
    [("shrug", 2.0), ("confused", 2.0), ("angry", 2.0), (None, 1.0)],
)
AREA_DATA[ToontownGlobals.CirrusCircus]["MOVEMODES"] = (
    [("walk", 1.0), ("running-jump", 0.4)],
    [("run", 0.4)],
    [("walk", 1.0), ("sad-walk", 2.5)],
)
...
AREA_DATA[ToontownGlobals.MintyMines]["DNA_TRIO"] = (
...
AREA_DATA[ToontownGlobals.MintyMines]["PATHS"] = (
    [
        Point3(-51.222, 90.874, 0.025),
...
AREA_DATA[ToontownGlobals.MintyMines]["PATHANIMREL"] = (0, 0, 1, 2)
AREA_DATA[ToontownGlobals.MintyMines]["ANIMATIONS"] = (
    [("wave", 2.0), (None, 1.0)],
    [("applause", 2.0), ("jump", 2.0), ("slip-forward", 2.0), (None, 1.0), (None, 1.0)],
    [("shrug", 2.0), ("angry", 2.0), (None, 1.0)],
)
AREA_DATA[ToontownGlobals.MintyMines]["MOVEMODES"] = (
    [("walk", 1.0), ("catch-run", 0.4)],
    [("run", 0.4), ("running-jump", 0.4)],
    [("walk", 1.0), ("sad-walk", 2.5)],
)
