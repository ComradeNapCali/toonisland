...
class TwoDCamera(DistributedObject.DistributedObject):
    ...
    def onstage(self):
        ...
        self.camera.setX(
            render, base.localAvatar.getX(render) + self.threeQuarterOffset
        )
    ...
    def update(self):
        if not self.ivalControllingCamera:
            camX = (
                ...
                - math.sin(base.localAvatar.getH(render) * math.pi / 180)
    ...
    def myLerpPos(self, t):
        ...
        finalCamX = (
            base.localAvatar.getX(render)
            - math.sin(self.newHeading * math.pi / 180) * self.threeQuarterOffset
        )
