...
class PurchaseBase(StateData.StateData):
    ...
    def __init__(self, toon, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                State.State(
                    "purchase", self.enterPurchase, self.exitPurchase, ["done"]
                ),
    ...
    def handlePurchase(self, track, level):
        ...
        if ret == -3:
            ...
            text = (
                TTLocalizer.GagShopTooManyOfThatGag
                % TTLocalizer.BattleGlobalAvPropStringsPlural[track][level]
            )
        elif ret == 0:
            text = TTLocalizer.GagShopInsufficientSkill
        else:
            text = (
                TTLocalizer.GagShopYouPurchased
