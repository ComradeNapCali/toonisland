...
CourseSections = (((20,
 ...
 ((15,
  ...
  (20,
   ...
   5,
   0)))
CourseWeights = {ToontownGlobals.ToonIslandCentral: ((0, 25),
                                   (1, 25),
                                   (2, 25),
                                   (3, 25)),
 ToontownGlobals.RainbowRise: ((1, 25),
                               (2, 25),
                               (3, 25),
                               (4, 25)),
 ToontownGlobals.WitheringWoods: ((2, 25),
                                (3, 25),
                                (4, 25),
                                (5, 25)),
 ToontownGlobals.OliveOasis: ((3, 25),
                                     (4, 25),
                                     (5, 25),
                                     (6, 25)),
 ToontownGlobals.CirrusCircus: ((4, 25),
                             (5, 25),
                             (6, 25),
                             (7, 25)),
 ToontownGlobals.MintyMines: ((4, 20),
                                    (5, 20),
                                    (6, 20),
                                    (7, 20),
                                    (8, 20))}
BaseBonusOnEndVine = {ToontownGlobals.ToonIslandCentral: 4,
...
BatInfo = {ToontownGlobals.ToonIslandCentral: ((60, 0, 0.35),),
...
SpiderLimits = {ToontownGlobals.ToonIslandCentral: 1,
