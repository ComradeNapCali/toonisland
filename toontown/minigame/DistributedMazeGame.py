...
class DistributedMazeGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.gameFSM = ClassicFSM.ClassicFSM(
            ...
            [
                ...
                State.State(
                    "play", self.enterPlay, self.exitPlay, ["cleanup", "showScores"]
                ),
                State.State(
    ...
    def onstage(self):
        ...
        self.goalBar = DirectWaitBar(
            ...
            scale=0.42,
            pos=(0.84, 0, 0.5 - 0.28 * self.numPlayers + 0.05),
            barColor=(0, 0.7, 0, 1),
        )
    ...
    def enterPlay(self):
        ...
        for i in range(self.numPlayers):
            ...
            scorePanel.setPos(-0.213333, 0.0, -0.5 - 0.28 * i)
    ...
    def __showToonHitBySuit(self, avId, timestamp):
        ...
        hitTrack = Sequence(
            Parallel(flyTrack, cameraTrack, spinHTrack, spinPTrack, soundTrack),
            Func(postFunc),
    ...
    def enterShowScores(self):
        ...
        lerpTrack.append(
            Parallel(
                LerpPosInterval(
                    self.goalBar, lerpDur, Point3(0, 0, -0.6), blendType="easeInOut"
                ),
                LerpScaleInterval(
                    self.goalBar,
                    lerpDur,
        ...
        self.showScoreTrack = Parallel(
            lerpTrack,
            Sequence(Wait(MazeGameGlobals.SHOWSCORES_DURATION), Func(self.gameOver)),
        )
