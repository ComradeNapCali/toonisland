...
parser = argparse.ArgumentParser(description="Toon Island: Aftermath - AI Server")
parser.add_argument("--base-channel", help="The base channel that the server will use.")
parser.add_argument(
    "--max-channels", help="The number of channels that the server will be able to use."
)
parser.add_argument(
    "--stateserver", help="The control channel of this AI's designated State Server."
)
parser.add_argument(
    "--district-name", help="The name of the district on this AI server."
)
parser.add_argument(
    "--astron-ip",
...
parser.add_argument(
    "--config",
    nargs="*",
    default=["dependencies/panda3d/general.prc", "dependencies/panda3d/dev.prc"],
