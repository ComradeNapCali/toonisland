...
class PurchaseManager(DistributedObject.DistributedObject):
    ...
    def announceGenerate(self):
        ...
        if self.hasLocalToon:
            ...
            base.cr.playGame.hood.fsm.request(
                "purchase",
                [
                    self.mpArray,
                    self.moneyArray,
    ...
    def calcHasLocalToon(self):
        retval = (
            base.localAvatar.doId not in self.newbieIds
            and base.localAvatar.doId in self.playerIds
        )
        if (
    ...
    def __handleBoughtGag(self):
        self.d_setInventory(
            base.localAvatar.inventory.makeNetString(), base.localAvatar.getMoney(), 0
        )
