...
class SuitPage(ShtikerPage.ShtikerPage):
    ...
    def addSummonButton(self, panel):
        ...
        summonButton = DirectButton(
            ...
            geom=iconGeom,
            geom_scale=0.7,
            text=("", TTLocalizer.IssueSummons, TTLocalizer.IssueSummons, ""),
            text_scale=0.4,
            text_pos=(-1.1, -0.4),
    ...
    def updateCogRadar(self, deptNum, panels, timeout=0):
        ...
        if (
            not timeout
            and hasattr(base.cr, "currSuitPlanner")
        ...
        for panel in panels:
            ...
            if self.radarOn[deptNum]:
                ...
                taskMgr.doMethodLater(
                    RADAR_DELAY * panels.index(panel),
                    showLabel,
                    "showCogRadarLater",
                ...
                if not self.radarButtons[deptNum].building:
                    taskMgr.doMethodLater(
                        RADAR_DELAY * len(panels), activateButton, "activateButtonLater"
                    )
            else:
                panel.cogRadarLabel.hide()
                panel.quotaLabel.show()
    ...
    def updateBuildingRadar(self, deptNum, timeout=0):
        ...
        if button.building:
            ...
            if self.radarOn[deptNum]:
                ...
                if num == 1:
                    button.buildingRadarLabel["text"] = (
                        TTLocalizer.SuitPageBuildingRadarS % num
                    )
                else:
                    button.buildingRadarLabel["text"] = (
                        TTLocalizer.SuitPageBuildingRadarP % num
                    )
                ...
                taskMgr.doMethodLater(
                    RADAR_DELAY * SuitDNA.suitsPerDept,
                    showLabel,
