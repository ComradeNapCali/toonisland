...
parser.add_argument('--server-ver', default='REVISION',
...
parser.add_argument('--configprc-dir', default='dependencies/panda3d',
                    help='The directory of the Panda3D Config.prc.')
parser.add_argument('--general-prc', default='general.prc',
                    help='The directory of the Panda3D Config.prc.')
parser.add_argument('--qa-prc', default='prod.prc',
                    help='The directory of the Panda3D Config.prc.')
